...
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var s=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(s=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!s))throw new Error("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&s)&&(r=new JQueryHttpClient(t));var n=e.on.response,o=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},a=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),n(e)};return e.on.response=function(e){a(e)},_.isObject(e)&&_.isObject(e.body)&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(o(e)),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||window.jQuery,r=e.on,s=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var t={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var i=a.substring(0,u).trim(),p=a.substring(u+1).trim();t[i]=p}else t[a]=null}}var l={url:s.url,method:s.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var d=e.responseJSON||jsyaml.safeLoad(e.responseText);l.obj="string"==typeof d?{}:d}catch(f){helpers.log("unable to parse JSON/YAML content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)r.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(l);r.error(l)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},n=request[t](e.url);for(r in s)n.set(r,s[r]);e.enableCookies&&n.withCredentials(),e.body&&n.send(e.body),"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(n.errObj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{n.obj=JSON.parse(n.statusText)}catch(o){n.obj=null}s=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&Object.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(o){helpers.log("cannot parse JSON/YAML content")}n.obj="object"==typeof a?a:null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"js-yaml":20,"lodash-compat/lang/isObject":152,"superagent":166}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,o,r,t,i,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+o];var p=r.allOf;for(p.sort(function(e,o){return e.$ref&&o.$ref?0:e.$ref?-1:1}),n=0;n<p.length;n++)f=p[n],l="/definitions/"+o+"/allOf",this.resolveInline(e,s,f,t,i,l)},Resolver.prototype.resolve=function(e,o,r,t){this.spec=e;var i,s,n=o,l=r,f=t,p={};"function"==typeof o&&(n=null,l=o,f=r);var a=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(p.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(p.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,y={},g={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,g,e):this.resolveTo(n,c,O,"/definitions");m.allOf&&this.processAllOf(n,h,m,O,g,e)}for(h in e.paths){var x,b,j;v=e.paths[h];for(x in v)if("$ref"===x)i="/paths"+h,this.resolveInline(n,e,v,O,g,i);else{b=v[x];var A=v.parameters||[],k=b.parameters||[];for(s in A){var R=A[s];k.unshift(R)}"parameters"!==x&&_.isObject(b)&&(b.parameters=b.parameters||k);for(s in k){var R=k[s];if(i="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,I=!1,q=0;!I;){if("undefined"==typeof e.definitions[h]){I=!0;break}h=$+"_"+q,q++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,g,e)}else this.resolveTo(n,R.schema,O,i);R.$ref&&this.resolveInline(n,e,R,O,g,R.$ref)}for(j in b.responses){var w=b.responses[j];i="/paths"+h+"/"+x+"/responses/"+j,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,g,i),w.schema&&this.resolveTo(n,w.schema,O,i))}}v.parameters=[]}var T,D=0,S=[],H=O;for(s=0;s<H.length;s++){var P=H[s];if(n===P.root){if("ref"===P.resolveAs){var z,N=((P.root||"")+"/"+P.key).split("/"),U=[],E="";if(P.key.indexOf("../")>=0){for(var J=0;J<N.length;J++)".."===N[J]?U=U.slice(0,U.length-1):U.push(N[J]);for(z=0;z<U.length;z++)z>0&&(E+="/"),E+=U[z];P.root=E,S.push(P)}else if(T=P.key.split("#"),2===T.length){(0===T[0].indexOf("http://")||0===T[0].indexOf("https://"))&&(P.root=T[0]),i=T[1].split("/");var Q,B=e;for(z=0;z<i.length;z++){var C=i[z];if(""!==C){if(B=B[C],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&S.push(P)}}else if("inline"===P.resolveAs){if(P.key&&-1===P.key.indexOf("#")&&"/"!==P.key.charAt(0)){for(T=P.root.split("/"),i="",s=0;s<T.length-1;s++)i+=T[s]+"/";i+=P.key,P.root=i,P.location=""}S.push(P)}}else S.push(P)}D=S.length;for(var F=0;F<S.length;F++)!function(e,o,r){if(null===e.root||e.root===n)r.resolveItem(o,a,O,y,g,e),u+=1,u===D&&r.finish(o,n,O,y,g,l,!0);else{var t={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(t){u+=1,g[e.key]={root:e.root,location:e.location},u===D&&r.finish(o,a,O,y,g,l)},response:function(t){var i=t.obj;r.resolveItem(i,e.root,O,y,g,e),u+=1,u===D&&r.finish(o,a,O,y,g,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(t),(new SwaggerHttp).execute(t,p)}}(S[F],e,this);0===Object.keys(S).length&&this.finish(e,a,O,y,g,l)},Resolver.prototype.resolveItem=function(e,o,r,t,i,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var p=0;p<f.length;p++){var a=f[p];if(-1!==a.indexOf("~1")&&(a=f[p].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==a.charAt(0)&&(a="/"+a)),"undefined"==typeof l||null===l)break;if(""===a&&p===f.length-1&&f.length>1){l=null;break}a.length>0&&(l=l[a])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?t[h]={name:v,obj:l,key:s.key,root:s.root}:i[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,o,r,t,i,s,n){var l;for(l in r){var f=r[l],p=f.key,a=t[p];if(a)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(p in a.obj)var h=this.retainRoot(a.obj[p],f.root);e.definitions[a.name]=a.obj,f.obj.$ref="#/definitions/"+a.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(p in a.obj){var h=a.obj[p];n!==!0&&(h=this.retainRoot(a.obj[p],f.root)),v[p]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,i)):(this.iteration+=1,this.resolve(e,o,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var o,r=this.getRefs(e),t=[],i=[];for(o in r)0===o.indexOf("#")?t.push(o.substring(1)):i.push(o);for(o=0;o<t.length;o++)for(var s=t[o],n=s.split("/"),l=e,f=0;f<n.length;f++){var p=n[f];if(""!==p&&(l=l[p],"undefined"==typeof l)){i.push(s);break}}return i.length},Resolver.prototype.getRefs=function(e,o){o=o||e;var r={};for(var t in o)if(o.hasOwnProperty(t)){var i=o[t];if("$ref"===t&&"string"==typeof i)r[i]=null;else if(_.isObject(i)){var s=this.getRefs(i);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,o){for(var r in e){var t=e[r];"$ref"===r&&"string"==typeof t?0!==t.indexOf("http://")&&0!==t.indexOf("https://")&&(0!==t.indexOf("#")&&(t="#"+t),t=(o||"")+t,e[r]=t):_.isObject(t)&&this.retainRoot(t,o)}return e},Resolver.prototype.resolveInline=function(e,o,r,t,i,s){var n,l,f,p,a=r.$ref,h=r.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))p=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+p[0],s=p[1];else{if(p=h.split("#"),""!==p[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=p[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),t.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],t.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})):t.push({obj:r,resolveAs:"inline",root:e,key:a,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,t,s)},Resolver.prototype.resolveTo=function(e,o,r,t){var i,s,n=o.$ref,l=e;if("undefined"!=typeof n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(i=e.split("/"),l="",s=0;s<i.length-1;s++)l+=i[s]+"/";l+=f[0]}t=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,t="";else{for(i=e.split("/"),l="",s=0;s<i.length-1;s++)l+=i[s]+"/";l+=n,t=""}r.push({obj:o,resolveAs:"ref",root:l,key:n,location:t})}else if("array"===o.type){var p=o.items;this.resolveTo(e,p,r,t)}else if(o&&o.properties){var a=this.uniqueName("inline_model");this.spec.definitions[a]=_.cloneDeep(o),o.$ref="#/definitions/"+a,delete o.type,delete o.properties}},Resolver.prototype.uniqueName=function(e){for(var o=e,r=0;;){if(!_.isObject(this.spec.definitions[o]))return o;o=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,o,r){r=r||0,o=o||e;var t;for(var i in o)if(o.hasOwnProperty(i)){var s=o[i];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+o+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var p=n[f],a="self";"undefined"!=typeof p["x-resolved-from"]&&(a=p["x-resolved-from"][0]);for(var h in p)if(l.hasOwnProperty(h))if("properties"===h){var v=p[h];for(t in v){l.properties[t]=_.cloneDeep(v[t]);var c=v[t]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=a),l.properties[t]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(p[h]),u=0;u<d.length;++u)for(var y=u+1;y<d.length;++y)d[u]===d[y]&&d.splice(y--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(a);else if(l[h]=_.cloneDeep(p[h]),"properties"===h)for(t in l[h])l[h][t]["x-resolved-from"]=a}o[i]=l}}_.isObject(s)&&this.resolveAllOf(e,s,r+1)}};
