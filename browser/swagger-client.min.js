...
},{"_process":14,"lodash-compat/array/indexOf":51,"lodash-compat/lang/isPlainObject":153}],5:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){this.type="JQueryHttpClient"},SuperagentHttpClient=function(){this.type="SuperagentHttpClient"},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var n=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(n=!0),"options"===e.method.toLowerCase()&&"SuperagentHttpClient"===r.type&&(log("forcing jQuery as OPTIONS are not supported by SuperAgent"),e.useJQuery=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!n))throw new Error("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&n)&&(r=new JQueryHttpClient(t));var o=e.on.response,s=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},a=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),o(e)};return e.on.response=function(e){a(e)},_.isObject(e)&&_.isObject(e.body)&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),e=s(e)||e,e.beforeSend?e.beforeSend(function(t){r.execute(t||e)}):r.execute(e),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||"undefined"!=typeof window&&window.jQuery,r=e.on,n=e;if("undefined"==typeof t||t===!1)throw new Error("Unsupported configuration! JQuery is required but not available");return e.type=e.method,e.cache=!1,e.data=e.body,delete e.useJQuery,delete e.body,e.complete=function(e){for(var t={},o=e.getAllResponseHeaders().split("\n"),s=0;s<o.length;s++){var a=o[s].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var i=a.substring(0,u).trim(),p=a.substring(u+1).trim();t[i]=p}else t[a]=null}}var d={url:n.url,method:n.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var l=e.responseJSON||jsyaml.safeLoad(e.responseText);d.obj="string"==typeof l?{}:l}catch(f){helpers.log("unable to parse JSON/YAML content")}if(d.obj=d.obj||null,e.status>=200&&e.status<300)r.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(d);r.error(d)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,n=e.headers||{},o=request[t](e.url);for(r in n)o.set(r,n[r]);e.enableCookies&&o.withCredentials(),e.body&&o.send(e.body),"function"==typeof o.buffer&&o.buffer(),o.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var n,o={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(o.errObj=t,o.status=r?r.status:500,o.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{o.obj=JSON.parse(o.statusText)}catch(s){o.obj=null}n=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&Object.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(s){helpers.log("cannot parse JSON/YAML content")}o.obj="object"==typeof a?a:null,o.status=r.status,o.statusText=r.text,n=e.on.response}o.data=o.statusText,n&&n(o)})};


},{"./helpers":4,"js-yaml":20,"lodash-compat/lang/isObject":152,"superagent":166}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){this.failedUrls=[]};Resolver.prototype.processAllOf=function(e,i,r,o,t,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+i];var a=r.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,o,t,l)},Resolver.prototype.resolve=function(e,i,r,o){this.spec=e;var t,s,n=i,l=r,f=o,a={};"function"==typeof i&&(n=null,l=i,f=r);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,m={},y={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var g=e.definitions[h];if(g.$ref)this.resolveInline(n,e,g,O,y,g);else{for(d in g.properties)c=g.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,y,e):this.resolveTo(n,c,O,"/definitions");g.allOf&&this.processAllOf(n,h,g,O,y,e)}}e.parameters=e.parameters||{};for(h in e.parameters){var x=e.parameters[h];if("body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,k=!1,A=0;!k;){if("undefined"==typeof e.definitions[h]){k=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,t);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(h in e.paths){var j,$,R;v=e.paths[h];for(j in v)if("$ref"===j)t="/paths"+h,this.resolveInline(n,e,v,O,y,t);else{$=v[j];var I=v.parameters||[],q=$.parameters||[];for(s in I){var x=I[s];q.unshift(x)}"parameters"!==j&&_.isObject($)&&($.parameters=$.parameters||q);for(s in q){var x=q[s];if(t="/paths"+h+"/"+j+"/parameters","body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,k=!1,A=0;!k;){if("undefined"==typeof e.definitions[h]){k=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,t);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(R in $.responses){var w=$.responses[R];if(t="/paths"+h+"/"+j+"/responses/"+R,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,y,t),w.schema)){var T=w;if(_.isArray(T.schema.allOf)){for(var b="inline_model",h=b,k=!1,A=0;!k;){if("undefined"==typeof e.definitions[h]){k=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else"array"===T.schema.type?T.schema.items&&T.schema.items.$ref&&this.resolveInline(n,e,T.schema.items,O,y,t):this.resolveTo(n,w.schema,O,t)}}}v.parameters=[]}var D,U=0,S=[],H=O;for(s=0;s<H.length;s++){var N=H[s];if(n===N.root){if("ref"===N.resolveAs){var P,z=((N.root||"")+"/"+N.key).split("/"),E=[],J="";if(N.key.indexOf("../")>=0){for(var Q=0;Q<z.length;Q++)".."===z[Q]?E=E.slice(0,E.length-1):E.push(z[Q]);for(P=0;P<E.length;P++)P>0&&(J+="/"),J+=E[P];N.root=J,S.push(N)}else if(D=N.key.split("#"),2===D.length){(0===D[0].indexOf("http://")||0===D[0].indexOf("https://"))&&(N.root=D[0]),t=D[1].split("/");var B,C=e;for(P=0;P<t.length;P++){var F=t[P];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&S.push(N)}}else if("inline"===N.resolveAs){if(N.key&&-1===N.key.indexOf("#")&&"/"!==N.key.charAt(0)){for(D=N.root.split("/"),t="",s=0;s<D.length-1;s++)t+=D[s]+"/";t+=N.key,N.root=t,N.location=""}S.push(N)}}else S.push(N)}U=S.length;for(var G=0;G<S.length;G++)!function(e,i,r){if(e.root&&e.root!==n)if(-1===r.failedUrls.indexOf(e.root)){var o={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(t){u+=1,console.log("failed url: "+o.url),r.failedUrls.push(o.url),y[e.key]={root:e.root,location:e.location},u===U&&r.finish(i,p,O,m,y,l)},response:function(o){var t=o.obj;r.resolveItem(t,e.root,O,m,y,e),u+=1,u===U&&r.finish(i,p,O,m,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(o),(new SwaggerHttp).execute(o,a)}else u+=1,y[e.key]={root:e.root,location:e.location},u===U&&r.finish(i,p,O,m,y,l);else r.resolveItem(i,p,O,m,y,e),u+=1,u===U&&r.finish(i,n,O,m,y,l,!0)}(S[G],e,this);0===Object.keys(S).length&&this.finish(e,p,O,m,y,l)},Resolver.prototype.resolveItem=function(e,i,r,o,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?o[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,r,o,t,s,n){var l;for(l in r){var f=r[l],a=f.key,p=o[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj)var h=this.retainRoot(p.obj[a],f.root);e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(p.obj[a],f.root)),v[a]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,r=this.getRefs(e),o=[],t=[];for(i in r)0===i.indexOf("#")?o.push(i.substring(1)):t.push(i);for(i=0;i<o.length;i++)for(var s=o[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var r={};for(var o in i)if(i.hasOwnProperty(o)){var t=i[o];if("$ref"===o&&"string"==typeof t)r[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,i){for(var r in e){var o=e[r];if("$ref"===r&&"string"==typeof o){if(0!==o.indexOf("http://")&&0!==o.indexOf("https://")){var t=!0;if(i){var s=i.slice(-1);if("/"!==s&&0!==o.indexOf("#")&&0!==o.indexOf("http://")&&o.indexOf("https://")){console.log("working with "+o),t=!1;var n=i.split("/");n=n.splice(0,n.length-1),i="";for(var l=0;l<n.length;l++)i+=n[l]+"/"}}0!==o.indexOf("#")&&t&&(o="#"+o),o=(i||"")+o,e[r]=o}}else _.isObject(o)&&this.retainRoot(o,i)}return e},Resolver.prototype.resolveInline=function(e,i,r,o,t,s){var n,l,f,a,p=r.$ref,h=r.$ref,v=!1;if(e=e||"",h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=a[1]}if(0===h.indexOf("http"))h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("#"))s=h.split("#")[1],o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("/")&&-1===h.indexOf("#")){s=h;var d=e.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i);d&&(e=d[0]+h.substring(1),s=""),o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,o,s)},Resolver.prototype.resolveTo=function(e,i,r,o){var t,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}o=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,o="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,o=""}r.push({obj:i,resolveAs:"ref",root:l,key:n,location:o})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,r,o)}else if(i&&i.properties){var p=this.uniqueName("inline_model");i.title&&(p=this.uniqueName(i.title)),delete i.title,this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,r=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,i,r){r=r||0,i=i||e;var o;for(var t in i)if(i.hasOwnProperty(t)){var s=i[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(o in v){l.properties[o]=_.cloneDeep(v[o]);var c=v[o]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=p),l.properties[o]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(a[h]),u=0;u<d.length;++u)for(var m=u+1;m<d.length;++m)d[u]===d[m]&&d.splice(m--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(o in l[h])l[h][o]["x-resolved-from"]=p}i[t]=l}}}};


},{"./http":5,"lodash-compat/lang/cloneDeep":146,"lodash-compat/lang/isArray":148,"lodash-compat/lang/isObject":152}],7:[function(require,module,exports){
...
},{"./helpers":4,"lodash-compat/array/indexOf":51,"lodash-compat/collection/forEach":58,"lodash-compat/collection/map":60,"lodash-compat/lang/cloneDeep":146,"lodash-compat/lang/isArray":148,"lodash-compat/lang/isEmpty":149,"lodash-compat/lang/isObject":152,"lodash-compat/lang/isPlainObject":153,"lodash-compat/lang/isUndefined":156,"lodash-compat/object/keys":157}],8:[function(require,module,exports){
...
},{"./http":5,"lodash-compat/lang/isObject":152}],9:[function(require,module,exports){
...
},{"../helpers":4,"../schema-markup.js":7,"js-yaml":20,"lodash-compat/lang/isPlainObject":153,"lodash-compat/lang/isString":154}],10:[function(require,module,exports){
"use strict";function maybeTransformValue(e,t){if(Array.isArray(e)&&!_.isUndefined(t)){if("pipes"===t.collectionFormat)return e.join("|");if("tsv"===t.collectionFormat)return e.join("\\t");if("csv"===t.collectionFormat)return e.join(",");if("ssv"===t.collectionFormat)return e.join(" ")}return e}function findParamByName(e,t){return _.find(t,function(t){return t&&e===t.name})}function transformArgs(e,t){var r={};return _.each(_.keys(e),function(i){var n=findParamByName(i,t);r[i]=maybeTransformValue(e[i],n)}),r}function itemByPriority(e,t){if(_.isEmpty(t))return e[0];for(var r=0,i=t.length;i>r;r++)if(e.indexOf(t[r])>-1)return t[r];return e[0]}var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined"),isEmpty:require("lodash-compat/lang/isEmpty"),isObject:require("lodash-compat/lang/isObject"),filter:require("lodash-compat/collection/filter"),find:require("lodash-compat/collection/find"),each:require("lodash-compat/collection/each"),map:require("lodash-compat/collection/map"),keys:require("lodash-compat/object/keys"),any:require("lodash-compat/collection/any")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Q=require("q"),UriTemplate=require("uritemplate"),Operation=module.exports=function(e,t,r,i,n,s,o,a,p){var l=[];if(e=e||{},s=s||{},e&&e.options&&(this.client=e.options.client||null,this.requestInterceptor=e.options.requestInterceptor||null,this.responseInterceptor=e.options.responseInterceptor||null),this.authorizations=s.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=s.consumes||e.consumes||["application/json"],this.produces=s.produces||e.produces||["application/json"],this.deprecated=s.deprecated,this.description=s.description,this.host=e.host||"localhost",this.method=i||l.push("Operation "+r+" is missing method."),this.models=a||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=s,this.operations={},this.parameters=null!==s?s.parameters||[]:{},this.parent=e,this.path=n||l.push("Operation "+this.nickname+" is missing path."),this.responses=s.responses||{},this.scheme=t||e.scheme||"http",this.schemes=s.schemes||e.schemes,this.security=s.security||e.security,this.summary=s.summary||"",this.type=null,this.useJQuery=e.useJQuery,this.enableCookies=e.enableCookies,this.parameterMacro=e.parameterMacro||function(e,t){return t["default"]},this.inlineModels=[],"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,c;if(o){var h;for(h in o)c=new Model(h,o[h],this.models,e.modelPropertyMacro),c&&(this.models[h]=c)}else o={};for(u=0;u<this.parameters.length;u++){var d=this.parameters[u];d["default"]=this.parameterMacro(this,d),"array"===d.type&&(d.isList=!0,d.allowMultiple=!0);var f=this.getType(d);if(f&&"boolean"===f.toString().toLowerCase()&&(d.allowableValues={},d.isList=!0,d["enum"]=[!0,!1]),"undefined"!=typeof d["x-example"]){var m=d["x-example"];d["default"]=m}if(d["x-examples"]){var m=d["x-examples"]["default"];"undefined"!=typeof m&&(d["default"]=m)}var y=d["enum"]||d.items&&d.items["enum"];if("undefined"!=typeof y){var g;for(d.allowableValues={},d.allowableValues.values=[],d.allowableValues.descriptiveValues=[],g=0;g<y.length;g++){var v=y[g],b=v===d["default"]||v+""===d["default"];d.allowableValues.values.push(v),d.allowableValues.descriptiveValues.push({value:v+"",isDefault:b})}}"array"===d.type&&(f=[f],"undefined"==typeof d.allowableValues&&(delete d.isList,delete d.allowMultiple)),d.modelSignature={type:f,definitions:this.models},d.signature=this.getModelSignature(f,this.models).toString(),d.sampleJSON=this.getModelSampleJSON(f,this.models),d.responseClassSignature=d.signature}var O,M,C=this.responses;if(C[200]?(M=C[200],O="200"):C[201]?(M=C[201],O="201"):C[202]?(M=C[202],O="202"):C[203]?(M=C[203],O="203"):C[204]?(M=C[204],O="204"):C[205]?(M=C[205],O="205"):C[206]?(M=C[206],O="206"):C["default"]&&(M=C["default"],O="default"),M&&M.schema){var x,P=this.resolveModel(M.schema,o);delete C[O],P?(this.successResponse={},x=this.successResponse[O]=P):M.schema.type&&"object"!==M.schema.type&&"array"!==M.schema.type?(this.successResponse={},x=this.successResponse[O]=M.schema):(this.successResponse={},x=this.successResponse[O]=new Model(void 0,M.schema||{},this.models,e.modelPropertyMacro)),x&&(M.description&&(x.description=M.description),M.examples&&(x.examples=M.examples),M.headers&&(x.headers=M.headers)),this.type=M}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t["default"]&&Array.isArray(t["default"])?-1!==t["default"].indexOf(e):e===t["default"]},Operation.prototype.getType=function(e){var t,r=e.type,i=e.format,n=!1;"integer"===r&&"int32"===i?t="integer":"integer"===r&&"int64"===i?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===i?"date-time":"date"===i?"date":"string":"number"===r&&"float"===i?t="float":"number"===r&&"double"===i?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r?(n=!0,e.items&&(t=this.getType(e.items))):"file"===r&&(t="file"),e.$ref&&(t=helpers.simpleRef(e.$ref));var s=e.schema;if(s){var o=s.$ref;return o?(o=helpers.simpleRef(o),n?[o]:o):"object"===s.type?this.addInlineModel(s):this.getType(s)}return n?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10),r=this.inlineModels[t];return r}return null},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var i=this.parameters[r],n=i.signature;t+="\n  * "+i.name+" ("+n+"): "+i.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,i;return e instanceof Array&&(i=!0,e=e[0]),"undefined"==typeof e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?i?"Array["+e+"]":e.toString():i?"Array["+e.getMockSignature()+"]":e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var i=this.parameters[r];if("undefined"!=typeof e[i.name]&&"header"===i["in"]){var n=e[i.name];Array.isArray(n)&&(n=n.toString()),t[i.name]=n}}return t},Operation.prototype.rfc6570CompliantUrl=function(e){var t="",r=this.stripQueryStringVariables(e),i=_.filter(this.parameters,function(e){return"query"===e["in"]});i.length>0&&(t=r.indexOf("?")>=0?"{&":"{?");for(var n=0,s=0;s<i.length;s++){var o=i[s];if("query"===o["in"]){n>0&&(t+=",");var a="";"multi"===o.collectionFormat&&(a="*"),t+=this.encodeQueryParam(o.name)+a,n++}}return i.length>0&&(t+="}"),r+t},Operation.prototype.stripQueryStringVariables=function(e){var t=/{(\w*)([\?\&]\w+(,\w+)+)}/g;return e.replace(t,"{$1}").replace("{}","").replace("}{","")},Operation.prototype.urlify=function(e){var t=this.rfc6570CompliantUrl(this.path),r=UriTemplate.parse(t),i=this.scheme+"://"+this.host;return"/"!==this.basePath&&(i+=this.basePath),i+r.expand(transformArgs(e,this.parameters)).replace(new RegExp("%2C","g"),",").replace(new RegExp("%7C","g"),"|").replace(new RegExp("%5C","g"),"\\")},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var i=this.parameters[t];i.required===!0&&"undefined"==typeof e[i.name]&&(r=i.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var i,n,s,o,a={},p=!1,l=0;l<this.parameters.length;l++){var u=this.parameters[l];"undefined"!=typeof t[u.name]?"body"===u["in"]?n=t[u.name]:"formData"===u["in"]&&(a[u.name]=t[u.name],i=!0):"body"===u["in"]&&(p=!0)}if(p&&"undefined"==typeof n){var c=e["Content-Type"];c&&0===c.indexOf("application/json")&&(n="{}")}var h=!1;if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&(h=!0),i&&!h){var d="";for(s in a)o=a[s],"undefined"!=typeof o&&(""!==d&&(d+="&"),d+=encodeURIComponent(s)+"="+encodeURIComponent(o));n=d}else if(h&&r.useJQuery){var f=new FormData;f.type="formData";for(s in a)o=t[s],"undefined"!=typeof o&&("file"===o.type&&o.value?(delete e["Content-Type"],f.append(s,o.value)):f.append(s,o));n=f}return n},Operation.prototype.getModelSampleJSON=function(e,t){var r,i,n;if(t=t||{},r=e instanceof Array,n=r?e[0]:e,t[n]?i=t[n].createJSONSample():this.getInlineModel(n)&&(i=this.getInlineModel(n).createJSONSample()),i){if(i=r?[i]:i,"string"==typeof i)return i;if(_.isObject(i)){var s=i;if(i instanceof Array&&i.length>0&&(s=i[0]),s.nodeName&&"Node"==typeof s){var o=(new XMLSerializer).serializeToString(s);return this.formatXml(o)}return JSON.stringify(i,null,2)}return i}},Operation.prototype["do"]=function(e,t,r,i,n){return this.execute(e,t,r,i,n)},Operation.prototype.execute=function(e,t,r,i,n){var s,o,a,p=e||{},l={};_.isObject(t)&&(l=t,s=r,o=i),this.client&&(l.client=this.client),!l.requestInterceptor&&this.requestInterceptor&&(l.requestInterceptor=this.requestInterceptor),!l.responseInterceptor&&this.responseInterceptor&&(l.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(s=t,o=r),this.parent.usePromise?a=Q.defer():(s=s||this.parent.defaultSuccessCallback||helpers.log,o=o||this.parent.defaultErrorCallback||helpers.log),"undefined"==typeof l.useJQuery&&(l.useJQuery=this.useJQuery),"undefined"==typeof l.enableCookies&&(l.enableCookies=this.enableCookies);var u=this.getMissingParams(p);if(u.length>0){var c="missing required params: "+u;return helpers.fail(c),this.parent.usePromise?(a.reject(c),a.promise):(o(c,n),{})}var h,d=this.getHeaderParams(p),f=this.setContentTypes(p,l),m={};for(h in d)m[h]=d[h];for(h in f)m[h]=f[h];var y=this.getBody(f,p,l),g=this.urlify(p);if(g.indexOf(".{format}")>0&&m){var v=m.Accept||m.accept;v&&v.indexOf("json")>0?g=g.replace(".{format}",".json"):v&&v.indexOf("xml")>0&&(g=g.replace(".{format}",".xml"))}var b={url:g,method:this.method.toUpperCase(),body:y,enableCookies:l.enableCookies,useJQuery:l.useJQuery,deferred:a,headers:m,clientAuthorizations:l.clientAuthorizations,on:{response:function(e){return a?(a.resolve(e),a.promise):s(e,n)},error:function(e){return a?(a.reject(e),a.promise):o(e,n)}}};return this.clientAuthorizations.apply(b,this.operation.security),l.mock===!0?b:(new SwaggerHttp).execute(b,l)},Operation.prototype.setContentTypes=function(e,t){var r,i,n=this.parameters,s=e.parameterContentType||itemByPriority(this.consumes,["application/json","application/yaml"]),o=t.responseContentType||itemByPriority(this.produces,["application/json","application/yaml"]),a=[],p=[],l={};for(i=0;i<n.length;i++){var u=n[i];if("formData"===u["in"])"file"===u.type?a.push(u):p.push(u);else if("header"===u["in"]&&t){var c=u.name,h=t[u.name];"undefined"!=typeof t[u.name]&&(l[c]=h)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}return"post"===this.method||"put"===this.method||"patch"===this.method||("delete"===this.method||"get"===this.method)&&r?(t.requestContentType&&(s=t.requestContentType),p.length>0&&(s=t.requestContentType?t.requestContentType:a.length>0?"multipart/form-data":"application/x-www-form-urlencoded")):s=null,s&&this.consumes&&-1===this.consumes.indexOf(s)&&helpers.log("server doesn't consume "+s+", try "+JSON.stringify(this.consumes)),this.matchesAccept(o)||helpers.log("server can't produce "+o),(s&&""!==r||"application/x-www-form-urlencoded"===s)&&(l["Content-Type"]=s),o&&(l.Accept=o),l},Operation.prototype.matchesAccept=function(e){return e&&this.produces?-1!==this.produces.indexOf(e)||-1!==this.produces.indexOf("*/*"):!0},Operation.prototype.asCurl=function(e,t){var r={mock:!0};if("object"==typeof t)for(var i in t)r[i]=t[i];var n=this.execute(e,r);this.clientAuthorizations.apply(n,this.operation.security);var s=[];if(s.push("-X "+this.method.toUpperCase()),"undefined"!=typeof n.headers){var o;for(o in n.headers){var a=n.headers[o];"string"==typeof a&&(a=a.replace(/\'/g,"\\u0027")),s.push("--header '"+o+": "+a+"'")}}if(n.body){var p;p=_.isObject(n.body)?JSON.stringify(n.body):n.body,s.push("-d '"+p.replace(/\'/g,"\\u0027")+"'")}return"curl "+s.join(" ")+" '"+n.url+"'"},Operation.prototype.encodePathCollection=function(e,t,r){var i,n="",s="";for(s="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",i=0;i<r.length;i++)0===i?n=this.encodeQueryParam(r[i]):n+=s+this.encodeQueryParam(r[i]);return n},Operation.prototype.encodeQueryCollection=function(e,t,r){var i,n="";if("default"===e||"multi"===e)for(i=0;i<r.length;i++)i>0&&(n+="&"),n+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[i]);else{var s="";if("csv"===e)s=",";else if("ssv"===e)s="%20";else if("tsv"===e)s="\\t";else if("pipes"===e)s="|";else if("brackets"===e)for(i=0;i<r.length;i++)0!==i&&(n+="&"),n+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[i]);if(""!==s)for(i=0;i<r.length;i++)0===i?n=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[i]):n+=s+this.encodeQueryParam(r[i])}return n},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){return encodeURIComponent(e)};


},{"../helpers":4,"../http":5,"./model":9,"lodash-compat/collection/any":54,"lodash-compat/collection/each":55,"lodash-compat/collection/filter":56,"lodash-compat/collection/find":57,"lodash-compat/collection/map":60,"lodash-compat/lang/cloneDeep":146,"lodash-compat/lang/isEmpty":149,"lodash-compat/lang/isObject":152,"lodash-compat/lang/isUndefined":156,"lodash-compat/object/keys":157,"q":165,"uritemplate":169}],11:[function(require,module,exports){
...
},{"base64-js":12,"ieee754":18,"is-array":19}],17:[function(require,module,exports){
...
},{"../type":33,"buffer":13}],35:[function(require,module,exports){
...
},{"../internal/baseIndexOf":85,"../internal/binaryIndex":100}],52:[function(require,module,exports){
...
},{"../internal/LazyWrapper":65,"../internal/LodashWrapper":66,"../internal/baseLodash":89,"../internal/isObjectLike":134,"../internal/wrapperClone":145,"../lang/isArray":148}],54:[function(require,module,exports){
module.exports=require("./some");


},{"./some":61}],55:[function(require,module,exports){
module.exports=require("./forEach");


},{"./forEach":58}],56:[function(require,module,exports){
...
},{"../internal/arrayFilter":69,"../internal/baseCallback":73,"../internal/baseFilter":78,"../lang/isArray":148}],57:[function(require,module,exports){
...
},{"../internal/baseEach":77,"../internal/createFind":110}],58:[function(require,module,exports){
...
},{"../internal/arrayEach":68,"../internal/baseEach":77,"../internal/createForEach":111}],59:[function(require,module,exports){
...
},{"../internal/baseIndexOf":85,"../internal/getLength":120,"../internal/isIterateeCall":130,"../internal/isLength":133,"../lang/isArray":148,"../lang/isString":154,"../object/values":160}],60:[function(require,module,exports){
...
},{"../internal/arrayMap":70,"../internal/baseCallback":73,"../internal/baseMap":90,"../lang/isArray":148}],61:[function(require,module,exports){
...
},{"../internal/arraySome":71,"../internal/baseCallback":73,"../internal/baseSome":97,"../internal/isIterateeCall":130,"../lang/isArray":148}],62:[function(require,module,exports){
...
},{"../internal/getNative":122}],63:[function(require,module,exports){
...
},{"../internal/createWrapper":114,"../internal/replaceHolders":140,"./restParam":64}],64:[function(require,module,exports){
...
},{"./baseCreate":76,"./baseLodash":89}],66:[function(require,module,exports){
...
},{"./baseCreate":76,"./baseLodash":89}],67:[function(require,module,exports){
...
},{"../object/keys":157,"./baseCopy":75}],73:[function(require,module,exports){
...
},{"../utility/identity":162,"../utility/property":164,"./baseMatches":91,"./baseMatchesProperty":92,"./bindCallback":102}],74:[function(require,module,exports){
...
},{"../lang/isArray":148,"../lang/isObject":152,"./arrayCopy":67,"./arrayEach":68,"./baseAssign":72,"./baseForOwn":83,"./initCloneArray":124,"./initCloneByTag":125,"./initCloneObject":126,"./isHostObject":128}],75:[function(require,module,exports){
...
},{"../lang/isObject":152}],77:[function(require,module,exports){
...
},{"./baseForOwn":83,"./createBaseEach":106}],78:[function(require,module,exports){
...
},{"./baseEach":77}],79:[function(require,module,exports){
...
},{"./createBaseFor":107}],82:[function(require,module,exports){
...
},{"../object/keysIn":158,"./baseFor":81}],83:[function(require,module,exports){
...
},{"../object/keys":157,"./baseFor":81}],84:[function(require,module,exports){
...
},{"./toObject":143}],85:[function(require,module,exports){
...
},{"./indexOfNaN":123}],86:[function(require,module,exports){
...
},{"../lang/isObject":152,"./baseIsEqualDeep":87,"./isObjectLike":134}],87:[function(require,module,exports){
...
},{"../lang/isArray":148,"../lang/isTypedArray":155,"./equalArrays":115,"./equalByTag":116,"./equalObjects":117,"./isHostObject":128}],88:[function(require,module,exports){
...
},{"./baseIsEqual":86,"./toObject":143}],89:[function(require,module,exports){
...
},{"./baseEach":77,"./isArrayLike":127}],91:[function(require,module,exports){
...
},{"./baseIsMatch":88,"./getMatchData":121,"./toObject":143}],92:[function(require,module,exports){
...
},{"../array/last":52,"../lang/isArray":148,"./baseGet":84,"./baseIsEqual":86,"./baseSlice":96,"./isKey":131,"./isStrictComparable":135,"./toObject":143,"./toPath":144}],93:[function(require,module,exports){
...
},{"./toObject":143}],94:[function(require,module,exports){
...
},{"./baseGet":84,"./toPath":144}],95:[function(require,module,exports){
...
},{"../utility/identity":162,"./metaMap":137}],96:[function(require,module,exports){
...
},{"./baseEach":77}],98:[function(require,module,exports){
...
},{"../utility/identity":162,"./binaryIndexBy":101}],101:[function(require,module,exports){
...
},{"../utility/identity":162}],103:[function(require,module,exports){
(function (global){
...
},{"./getLength":120,"./isLength":133,"./toObject":143}],107:[function(require,module,exports){
...
},{"./toObject":143}],108:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":109}],109:[function(require,module,exports){
...
},{"../lang/isObject":152,"./baseCreate":76}],110:[function(require,module,exports){
...
},{"../lang/isArray":148,"./baseCallback":73,"./baseFind":79,"./baseFindIndex":80}],111:[function(require,module,exports){
...
},{"../lang/isArray":148,"./bindCallback":102}],112:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":67,"./composeArgs":104,"./composeArgsRight":105,"./createCtorWrapper":109,"./isLaziable":132,"./reorder":139,"./replaceHolders":140,"./setData":141}],113:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":109}],114:[function(require,module,exports){
...
},{"./baseSetData":95,"./createBindWrapper":108,"./createHybridWrapper":112,"./createPartialWrapper":113,"./getData":118,"./mergeData":136,"./setData":141}],115:[function(require,module,exports){
...
},{"./arraySome":71}],116:[function(require,module,exports){
...
},{"../object/keys":157}],118:[function(require,module,exports){
...
},{"../utility/noop":163,"./metaMap":137}],119:[function(require,module,exports){
...
},{"./realNames":138}],120:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":93}],121:[function(require,module,exports){
...
},{"../object/pairs":159,"./isStrictComparable":135}],122:[function(require,module,exports){
...
},{"../lang/isNative":151}],123:[function(require,module,exports){
...
},{"./bufferClone":103}],126:[function(require,module,exports){
...
},{"./getLength":120,"./isLength":133}],128:[function(require,module,exports){
...
},{"../lang/isObject":152,"./isArrayLike":127,"./isIndex":129}],131:[function(require,module,exports){
...
},{"../lang/isArray":148,"./toObject":143}],132:[function(require,module,exports){
...
},{"../chain/lodash":53,"./LazyWrapper":65,"./getData":118,"./getFuncName":119}],133:[function(require,module,exports){
...
},{"../lang/isObject":152}],136:[function(require,module,exports){
...
},{"./arrayCopy":67,"./composeArgs":104,"./composeArgsRight":105,"./replaceHolders":140}],137:[function(require,module,exports){
(function (global){
var getNative=require("./getNative"),WeakMap=getNative(global,"WeakMap"),metaMap=WeakMap&&new WeakMap;module.exports=metaMap;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./getNative":122}],138:[function(require,module,exports){
...
},{"./arrayCopy":67,"./isIndex":129}],140:[function(require,module,exports){
...
},{"../date/now":62,"./baseSetData":95}],142:[function(require,module,exports){
...
},{"../lang/isArguments":147,"../lang/isArray":148,"../lang/isString":154,"../object/keysIn":158,"./isIndex":129,"./isLength":133}],143:[function(require,module,exports){
...
},{"../lang/isObject":152,"../lang/isString":154,"../support":161}],144:[function(require,module,exports){
...
},{"../lang/isArray":148,"./baseToString":98}],145:[function(require,module,exports){
...
},{"./LazyWrapper":65,"./LodashWrapper":66,"./arrayCopy":67}],146:[function(require,module,exports){
...
},{"../internal/baseClone":74,"../internal/bindCallback":102}],147:[function(require,module,exports){
...
},{"../internal/isArrayLike":127,"../internal/isObjectLike":134}],148:[function(require,module,exports){
...
},{"../internal/getNative":122,"../internal/isLength":133,"../internal/isObjectLike":134}],149:[function(require,module,exports){
...
},{"../internal/isArrayLike":127,"../internal/isObjectLike":134,"../object/keys":157,"./isArguments":147,"./isArray":148,"./isFunction":150,"./isString":154}],150:[function(require,module,exports){
...
},{"../internal/isHostObject":128,"../internal/isObjectLike":134,"./isFunction":150}],152:[function(require,module,exports){
...
},{"../internal/baseForIn":82,"../internal/isHostObject":128,"../internal/isObjectLike":134,"../support":161,"./isArguments":147}],154:[function(require,module,exports){
...
},{"../internal/isObjectLike":134}],155:[function(require,module,exports){
...
},{"../internal/isLength":133,"../internal/isObjectLike":134}],156:[function(require,module,exports){
...
},{"../internal/getNative":122,"../internal/isArrayLike":127,"../internal/shimKeys":142,"../lang/isObject":152,"../support":161}],158:[function(require,module,exports){
...
},{"../internal/arrayEach":68,"../internal/isIndex":129,"../internal/isLength":133,"../lang/isArguments":147,"../lang/isArray":148,"../lang/isFunction":150,"../lang/isObject":152,"../lang/isString":154,"../support":161}],159:[function(require,module,exports){
...
},{"../internal/toObject":143,"./keys":157}],160:[function(require,module,exports){
...
},{"../internal/baseValues":99,"./keys":157}],161:[function(require,module,exports){
...
},{"../internal/baseProperty":93,"../internal/basePropertyDeep":94,"../internal/isKey":131}],165:[function(require,module,exports){
(function (process){
...
},{"_process":14}],166:[function(require,module,exports){
