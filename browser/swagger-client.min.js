...
},{"./helpers":4,"btoa":15,"cookiejar":18,"lodash-compat/collection/each":56,"lodash-compat/collection/includes":60,"lodash-compat/lang/isArray":149,"lodash-compat/lang/isObject":153}],3:[function(require,module,exports){
"use strict";var _={bind:require("lodash-compat/function/bind"),cloneDeep:require("lodash-compat/lang/cloneDeep"),find:require("lodash-compat/collection/find"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isObject:require("lodash-compat/lang/isObject"),isFunction:require("lodash-compat/lang/isFunction"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined")},auth=require("./auth"),helpers=require("./helpers"),Model=require("./types/model"),Operation=require("./types/operation"),OperationGroup=require("./types/operationGroup"),Resolver=require("./resolver"),SwaggerHttp=require("./http"),SwaggerSpecConverter=require("./spec-converter"),Q=require("q"),reservedClientTags=["apis","authorizationScheme","authorizations","basePath","build","buildFrom1_1Spec","buildFrom1_2Spec","buildFromSpec","clientAuthorizations","convertInfo","debug","defaultErrorCallback","defaultSuccessCallback","enableCookies","fail","failure","finish","help","host","idFromOp","info","initialize","isBuilt","isValid","modelPropertyMacro","models","modelsArray","options","parameterMacro","parseUri","progress","resourceCount","sampleModels","selfReflect","setConsolidatedModels","spec","supportedSubmitMethods","swaggerRequestHeaders","tagFromLabel","title","url","useJQuery","jqueryAjaxCache"],reservedApiTags=["apis","asCurl","description","externalDocs","help","label","name","operation","operations","operationsArray","path","tag"],supportedOperationMethods=["delete","get","head","options","patch","post","put"],SwaggerClient=module.exports=function(e,i){return this.authorizations=null,this.authorizationScheme=null,this.basePath=null,this.debug=!1,this.enableCookies=!1,this.info=null,this.isBuilt=!1,this.isValid=!1,this.modelsArray=[],this.resourceCount=0,this.url=null,this.useJQuery=!1,this.jqueryAjaxCache=!1,this.swaggerObject={},this.deferredClient=void 0,this.clientAuthorizations=new auth.SwaggerAuthorizations,"undefined"!=typeof e?this.initialize(e,i):this};SwaggerClient.prototype.initialize=function(e,i){return this.models={},this.sampleModels={},"string"==typeof e?this.url=e:_.isObject(e)&&(i=e,this.url=i.url),this.url&&-1===this.url.indexOf("http:")&&-1===this.url.indexOf("https:")&&"undefined"!=typeof window&&window&&window.location&&(this.url=window.location.origin+this.url),i=i||{},this.clientAuthorizations.add(i.authorizations),this.swaggerRequestHeaders=i.swaggerRequestHeaders||"application/json;charset=utf-8,*/*",this.defaultSuccessCallback=i.defaultSuccessCallback||null,this.defaultErrorCallback=i.defaultErrorCallback||null,this.modelPropertyMacro=i.modelPropertyMacro||null,this.parameterMacro=i.parameterMacro||null,this.usePromise=i.usePromise||null,this.usePromise&&(this.deferredClient=Q.defer()),"function"==typeof i.success&&(this.success=i.success),i.useJQuery&&(this.useJQuery=i.useJQuery),i.jqueryAjaxCache&&(this.jqueryAjaxCache=i.jqueryAjaxCache),i.enableCookies&&(this.enableCookies=i.enableCookies),this.options=i||{},this.supportedSubmitMethods=i.supportedSubmitMethods||[],this.failure=i.failure||function(e){throw e},this.progress=i.progress||function(){},this.spec=_.cloneDeep(i.spec),i.scheme&&(this.scheme=i.scheme),this.usePromise||"function"==typeof i.success?(this.ready=!0,this.build()):void 0},SwaggerClient.prototype.build=function(e){if(this.isBuilt)return this;var i=this;this.spec?this.progress("fetching resource list; Please wait."):this.progress("fetching resource list: "+this.url+"; Please wait.");var t={useJQuery:this.useJQuery,jqueryAjaxCache:this.jqueryAjaxCache,url:this.url,method:"get",headers:{accept:this.swaggerRequestHeaders},on:{error:function(e){return"http"!==i.url.substring(0,4)?i.fail("Please specify the protocol for "+i.url):0===e.status?i.fail("Can't read from server.  It may not have the appropriate access-control-origin settings."):404===e.status?i.fail("Can't read swagger JSON from "+i.url):i.fail(e.status+" : "+e.statusText+" "+i.url)},response:function(e){var t=e.obj;if(!t)return i.fail("failed to parse JSON/YAML response");if(i.swaggerVersion=t.swaggerVersion,i.swaggerObject=t,t.swagger&&2===parseInt(t.swagger))i.swaggerVersion=t.swagger,(new Resolver).resolve(t,i.url,i.buildFromSpec,i),i.isValid=!0;else{var s=new SwaggerSpecConverter;i.oldSwaggerObject=i.swaggerObject,s.setDocumentationLocation(i.url),s.convert(t,i.clientAuthorizations,i.options,function(e){i.swaggerObject=e,(new Resolver).resolve(e,i.url,i.buildFromSpec,i),i.isValid=!0})}}}};if(this.spec)i.swaggerObject=this.spec,setTimeout(function(){(new Resolver).resolve(i.spec,i.url,i.buildFromSpec,i)},10);else{if(this.clientAuthorizations.apply(t),e)return t;(new SwaggerHttp).execute(t,this.options)}return this.usePromise?this.deferredClient.promise:this},SwaggerClient.prototype.buildFromSpec=function(e){if(this.isBuilt)return this;this.apis={},this.apisArray=[],this.basePath=e.basePath||"",this.consumes=e.consumes,this.host=e.host||"",this.info=e.info||{},this.produces=e.produces,this.schemes=e.schemes||[],this.securityDefinitions=e.securityDefinitions,this.security=e.security,this.title=e.title||"",e.externalDocs&&(this.externalDocs=e.externalDocs),this.authSchemes=e.securityDefinitions;var i,t={};if(Array.isArray(e.tags))for(t={},i=0;i<e.tags.length;i++){var s=e.tags[i];t[s.name]=s}var r;"string"==typeof this.url?(r=this.parseUri(this.url),"undefined"==typeof this.scheme&&"undefined"==typeof this.schemes||0===this.schemes.length?this.scheme=r.scheme||"http":"undefined"==typeof this.scheme&&(this.scheme=this.schemes[0]||r.scheme),("undefined"==typeof this.host||""===this.host)&&(this.host=r.host,r.port&&(this.host=this.host+":"+r.port))):"undefined"==typeof this.schemes||0===this.schemes.length?this.scheme="http":"undefined"==typeof this.scheme&&(this.scheme=this.schemes[0]),this.definitions=e.definitions;var o;for(o in this.definitions){var a=new Model(o,this.definitions[o],this.models,this.modelPropertyMacro);a&&(this.models[o]=a)}var n=this;n.apis.help=_.bind(n.help,n),_.forEach(e.paths,function(e,i){_.isPlainObject(e)&&_.forEach(supportedOperationMethods,function(s){var r=e[s];if(!_.isUndefined(r)){if(!_.isPlainObject(r))return void helpers.log("The '"+s+"' operation for '"+i+"' path is not an Operation Object");var o=r.tags;(_.isUndefined(o)||!_.isArray(o)||0===o.length)&&(o=r.tags=["default"]);var a=n.idFromOp(i,s,r),h=new Operation(n,r.scheme,a,s,i,r,n.definitions,n.models,n.clientAuthorizations);_.forEach(o,function(e){var i=_.indexOf(reservedClientTags,e)>-1?"_"+e:e,s=_.indexOf(reservedApiTags,e)>-1?"_"+e:e,r=n[i];if(i!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient function/property name.  Use 'client."+i+"' or 'client.apis."+e+"' instead of 'client."+e+"'."),s!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"' instead of 'client.apis."+e+"'."),_.indexOf(reservedApiTags,a)>-1&&(helpers.log("The '"+a+"' operationId conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"._"+a+"' instead of 'client.apis."+s+"."+a+"'."),a="_"+a,h.nickname=a),_.isUndefined(r)){r=n[i]=n.apis[s]={},r.operations={},r.label=s,r.apis={};var o=t[e];_.isUndefined(o)||(r.description=o.description,r.externalDocs=o.externalDocs),n[i].help=_.bind(n.help,r),n.apisArray.push(new OperationGroup(e,r.description,r.externalDocs,h))}a=n.makeUniqueOperationId(a,n.apis[s]),_.isFunction(r.help)||(r.help=_.bind(n.help,r)),n.apis[s][a]=r[a]=_.bind(h.execute,h),n.apis[s][a].help=r[a].help=_.bind(h.help,h),n.apis[s][a].asCurl=r[a].asCurl=_.bind(h.asCurl,h),r.apis[a]=r.operations[a]=h;var l=_.find(n.apisArray,function(i){return i.tag===e});l&&l.operationsArray.push(h)})}})});var h=[];return _.forEach(Object.keys(t),function(e){var i;for(i in n.apisArray){var t=n.apisArray[i];t&&e===t.name&&(h.push(t),n.apisArray[i]=null)}}),_.forEach(n.apisArray,function(e){e&&h.push(e)}),n.apisArray=h,_.forEach(e.definitions,function(e,i){e.id=i.toLowerCase(),e.name=i,n.modelsArray.push(e)}),this.isBuilt=!0,this.usePromise?(this.isValid=!0,this.isBuilt=!0,this.deferredClient.resolve(this),this.deferredClient.promise):(this.success&&this.success(),this)},SwaggerClient.prototype.makeUniqueOperationId=function(e,i){for(var t=0,s=e;;){var r=!1;if(_.forEach(i.operations,function(e){e.nickname===s&&(r=!0)}),!r)return s;s=e+"_"+t,t++}return e},SwaggerClient.prototype.parseUri=function(e){var i=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,t=i.exec(e);return{scheme:t[4]?t[4].replace(":",""):void 0,host:t[11],port:t[12],path:t[15]}},SwaggerClient.prototype.help=function(e){var i="";return this instanceof SwaggerClient?_.forEach(this.apis,function(e,t){_.isPlainObject(e)&&(i+="operations for the '"+t+"' tag\n",_.forEach(e.operations,function(e,t){i+="  * "+t+": "+e.summary+"\n"}))}):(this instanceof OperationGroup||_.isPlainObject(this))&&(i+="operations for the '"+this.label+"' tag\n",_.forEach(this.apis,function(e,t){i+="  * "+t+": "+e.summary+"\n"})),e?i:(helpers.log(i),i)},SwaggerClient.prototype.tagFromLabel=function(e){return e},SwaggerClient.prototype.idFromOp=function(e,i,t){t&&t.operationId||(t=t||{},t.operationId=i+"_"+e);var s=t.operationId.replace(/[\s!@#$%^&*()_+=\[{\]};:<>|.\/?,\\'""-]/g,"_")||e.substring(1)+"_"+i;return s=s.replace(/((_){2,})/g,"_"),s=s.replace(/^(_)*/g,""),s=s.replace(/([_])*$/g,"")},SwaggerClient.prototype.setHost=function(e){this.host=e,this.apis&&_.forEach(this.apis,function(i){i.operations&&_.forEach(i.operations,function(i){i.host=e})})},SwaggerClient.prototype.setBasePath=function(e){this.basePath=e,this.apis&&_.forEach(this.apis,function(i){i.operations&&_.forEach(i.operations,function(i){i.basePath=e})})},SwaggerClient.prototype.setSchemes=function(e){this.schemes=e,e&&e.length>0&&this.apis&&_.forEach(this.apis,function(i){i.operations&&_.forEach(i.operations,function(i){i.scheme=e[0]})})},SwaggerClient.prototype.fail=function(e){return this.usePromise?(this.deferredClient.reject(e),this.deferredClient.promise):void(this.failure?this.failure(e):this.failure(e))};


},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":8,"./types/model":9,"./types/operation":10,"./types/operationGroup":11,"lodash-compat/array/indexOf":52,"lodash-compat/collection/find":58,"lodash-compat/collection/forEach":59,"lodash-compat/function/bind":64,"lodash-compat/lang/cloneDeep":147,"lodash-compat/lang/isArray":149,"lodash-compat/lang/isFunction":151,"lodash-compat/lang/isObject":153,"lodash-compat/lang/isPlainObject":154,"lodash-compat/lang/isUndefined":157,"q":166}],4:[function(require,module,exports){
(function (process){
...
},{"_process":14,"lodash-compat/array/indexOf":52,"lodash-compat/lang/isPlainObject":154}],5:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject"),keys:require("lodash-compat/object/keys")},JQueryHttpClient=function(){this.type="JQueryHttpClient"},SuperagentHttpClient=function(){this.type="SuperagentHttpClient"},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var o=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(o=!0),"options"===e.method.toLowerCase()&&"SuperagentHttpClient"===r.type&&(log("forcing jQuery as OPTIONS are not supported by SuperAgent"),e.useJQuery=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!o))throw new Error("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&o)&&(r=new JQueryHttpClient(t));var n=e.on.response,s=e.on.error,a=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},i=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),n(e)},u=function(e){t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),s(e)};return e.on.error=function(e){u(e)},e.on.response=function(e){i(e)},_.isObject(e)&&_.isObject(e.body)&&e.body.type&&"formData"===e.body.type&&t.useJQuery&&(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]),e=a(e)||e,e.beforeSend?e.beforeSend(function(t){r.execute(t||e)}):r.execute(e),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||"undefined"!=typeof window&&window.jQuery,r=e.on,o=e;if("undefined"==typeof t||t===!1)throw new Error("Unsupported configuration! JQuery is required but not available");return e.type=e.method,e.cache=e.jqueryAjaxCache,e.data=e.body,delete e.jqueryAjaxCache,delete e.useJQuery,delete e.body,e.complete=function(e){for(var t={},n=e.getAllResponseHeaders().split("\n"),s=0;s<n.length;s++){var a=n[s].trim();if(0!==a.length){var i=a.indexOf(":");if(-1!==i){var u=a.substring(0,i).trim(),p=a.substring(i+1).trim();t[u]=p}else t[a]=null}}var d={url:o.url,method:o.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var l=e.responseJSON||jsyaml.safeLoad(e.responseText);d.obj="string"==typeof l?{}:l}catch(y){helpers.log("unable to parse JSON/YAML content")}if(d.obj=d.obj||null,e.status>=200&&e.status<300)r.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(d);r.error(d)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r=e.headers||{},o=request[t](e.url);if(e.enableCookies&&o.withCredentials(),e.body)if(_.isObject(e.body)){var n=e.headers["Content-Type"]||"";if(0===n.indexOf("multipart/form-data"))if(delete r["Content-Type"],"[object FormData]"==={}.toString.apply(e.body))for(var s=e.body.keys();;){var a=s.next();if(a.done)break;var i=a.value,u=e.body.get(i);console.log({}.toString.apply(u)),"[object File]"==={}.toString.apply(u)?o.attach(i,u):o.field(i,u)}else{var p;for(var p in e.body){var u=e.body[p];o.field(p,u)}}else _.isObject(e.body)&&(e.body=JSON.stringify(e.body),o.send(e.body))}else o.send(e.body);var d;for(d in r)o.set(d,r[d]);"function"==typeof o.buffer&&o.buffer(),o.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var o,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(n.errObj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{n.obj=JSON.parse(n.statusText)}catch(s){n.obj=null}o=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&_.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(s){helpers.log("cannot parse JSON/YAML content")}n.obj="object"==typeof a?a:null,n.status=r.status,n.statusText=r.text,o=e.on.response}n.data=n.statusText,o&&o(n)})};


},{"./helpers":4,"js-yaml":21,"lodash-compat/lang/isObject":153,"lodash-compat/object/keys":158,"superagent":167}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray"),isString:require("lodash-compat/lang/isString")},Resolver=module.exports=function(){this.failedUrls=[],this.resolverCache={},this.pendingUrls={}};Resolver.prototype.processAllOf=function(e,i,r,t,o,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+i];var a=r.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,t,o,l)},Resolver.prototype.resolve=function(e,i,r,t){this.spec=e;var o,s,n=i,l=r,f=t,a={};"function"==typeof i&&(n=null,l=i,f=r);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,m={},y={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var g=e.definitions[h];if(g.$ref)this.resolveInline(n,e,g,O,y,g);else{for(d in g.properties)c=g.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,y,e):this.resolveTo(n,c,O,"/definitions");g.allOf&&this.processAllOf(n,h,g,O,y,e)}}e.parameters=e.parameters||{};for(h in e.parameters){var x=e.parameters[h];if("body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,j=!1,A=0;!j;){if("undefined"==typeof e.definitions[h]){j=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,o);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(h in e.paths){var k,$,R;v=e.paths[h];for(k in v)if("$ref"===k)o="/paths"+h,this.resolveInline(n,e,v,O,y,o);else{$=v[k];var I=v.parameters||[],q=$.parameters||[];for(s in I){var x=I[s];q.unshift(x)}"parameters"!==k&&_.isObject($)&&($.parameters=$.parameters||q);for(s in q){var x=q[s];if(o="/paths"+h+"/"+k+"/parameters","body"===x["in"]&&x.schema)if(_.isArray(x.schema.allOf)){for(var b="inline_model",h=b,j=!1,A=0;!j;){if("undefined"==typeof e.definitions[h]){j=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:x.schema.allOf},delete x.schema.allOf,x.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,x.schema,O,o);x.$ref&&this.resolveInline(n,e,x,O,y,x.$ref)}for(R in $.responses){var w=$.responses[R];if(o="/paths"+h+"/"+k+"/responses/"+R,_.isObject(w)&&(w.$ref&&this.resolveInline(n,e,w,O,y,o),w.schema)){var T=w;if(_.isArray(T.schema.allOf)){for(var b="inline_model",h=b,j=!1,A=0;!j;){if("undefined"==typeof e.definitions[h]){j=!0;break}h=b+"_"+A,A++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else"array"===T.schema.type?T.schema.items&&T.schema.items.$ref&&this.resolveInline(n,e,T.schema.items,O,y,o):this.resolveTo(n,w.schema,O,o)}}}v.parameters=[]}var S,D=0,U=[],C=O;for(s=0;s<C.length;s++){var P=C[s];if(n===P.root){if("ref"===P.resolveAs){var H,N=((P.root||"")+"/"+P.key).split("/"),z=[],E="";if(P.key.indexOf("../")>=0){for(var J=0;J<N.length;J++)".."===N[J]?z=z.slice(0,z.length-1):z.push(N[J]);for(H=0;H<z.length;H++)H>0&&(E+="/"),E+=z[H];P.root=E,U.push(P)}else if(S=P.key.split("#"),2===S.length){(0===S[0].indexOf("http:")||0===S[0].indexOf("https:"))&&(P.root=S[0]),o=S[1].split("/");var Q,B=e;for(H=0;H<o.length;H++){var F=o[H];if(""!==F){if(B=B[F],"undefined"==typeof B){Q=null;break}Q=B}}null===Q&&U.push(P)}}else if("inline"===P.resolveAs){if(P.key&&-1===P.key.indexOf("#")&&"/"!==P.key.charAt(0)){for(S=P.root.split("/"),o="",s=0;s<S.length-1;s++)o+=S[s]+"/";o+=P.key,P.root=o,P.location=""}U.push(P)}}else U.push(P)}D=U.length;for(var G={},K=0;K<U.length;K++)!function(e,i,r,t,o){if(e.root&&e.root!==n)if(-1===r.failedUrls.indexOf(e.root)){var s={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(o){u+=1,console.log("failed url: "+s.url),r.failedUrls.push(s.url),t&&delete t[e.root],y[e.key]={root:e.root,location:e.location},u===D&&r.finish(i,p,O,m,y,l)},response:function(o){var s=o.obj;t&&delete t[e.root],r.resolverCache&&(r.resolverCache[e.root]=s),r.resolveItem(s,e.root,O,m,y,e),u+=1,u===D&&r.finish(i,p,O,m,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(s),function h(){setTimeout(function(){if(t[s.url])h();else{var e=r.resolverCache[s.url];_.isObject(e)?(s.on.response({obj:e}),1):(t[s.url]=!0,(new SwaggerHttp).execute(s,a))}},0)}()}else u+=1,y[e.key]={root:e.root,location:e.location},u===D&&r.finish(i,p,O,m,y,l);else r.resolveItem(i,p,O,m,y,e),u+=1,u===D&&r.finish(i,n,O,m,y,l,!0)}(U[K],e,this,G,K);0===Object.keys(U).length&&this.finish(e,p,O,m,y,l)},Resolver.prototype.resolveItem=function(e,i,r,t,o,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?t[h]={name:v,obj:l,key:s.key,root:s.root}:o[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,r,t,o,s,n){var l;for(l in r){var f=r[l],a=f.key,p=t[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj){var h=this.retainRoot(a,p.obj[a],f.root);p.obj[a]=h}e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(a,p.obj[a],f.root)),v[a]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),this.resolverCache=null,s.call(this.scope,e,o)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,r=this.getRefs(e),t=[],o=[];for(i in r)0===i.indexOf("#")?t.push(i.substring(1)):o.push(i);for(i=0;i<t.length;i++)for(var s=t[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){o.push(s);break}}return o.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var r={};for(var t in i)if(i.hasOwnProperty(t)){var o=i[t];if("$ref"===t&&"string"==typeof o)r[o]=null;else if(_.isObject(o)){var s=this.getRefs(o);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,i,r){if(_.isObject(i))for(var t in i){var o=i[t];if("$ref"===t&&"string"==typeof o){if(0!==o.indexOf("http:")&&0!==o.indexOf("https:")){var s=!0;if(r){var n=r.slice(-1);if("/"!==n&&0!==o.indexOf("#")&&0!==o.indexOf("http:")&&o.indexOf("https:")){s=!1;var l=r.split("/");l=l.splice(0,l.length-1),r="";for(var f=0;f<l.length;f++)r+=l[f]+"/"}}0!==o.indexOf("#")&&s&&(o="#"+o),o=(r||"")+o,i[t]=o}}else _.isObject(o)&&this.retainRoot(t,o,r)}else _.isString(i)&&"$ref"===e&&-1===i.indexOf("http:")&&-1===i.indexOf("https:")&&(i=r+i);return i},Resolver.prototype.resolveInline=function(e,i,r,t,o,s){var n,l,f,a,p=r.$ref,h=r.$ref,v=!1;if(e=e||"",h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=a[1]}if(0===h.indexOf("http:")||0===h.indexOf("https:"))h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("#"))s=h.split("#")[1],t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s});else if(0===h.indexOf("/")&&-1===h.indexOf("#")){s=h;var d=e.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i);d&&(e=d[0]+h.substring(1),s=""),t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else t.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,t,s)},Resolver.prototype.resolveTo=function(e,i,r,t){var o,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(!f[0]||0!==f[0].indexOf("http:")&&0!==f[0].indexOf("https:")){if(f[0]&&f[0].length>0){for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=f[0]}}else l=f[0],n=f[1];t=f[1]}else if(0===n.indexOf("http:")||0===n.indexOf("https:"))l=n,t="";else{for(o=e.split("/"),l="",s=0;s<o.length-1;s++)l+=o[s]+"/";l+=n,t=""}r.push({obj:i,resolveAs:"ref",root:l,key:n,location:t})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,r,t)}else if(i&&(i.properties||i.additionalProperties)){var p=this.uniqueName("inline_model");i.title&&(p=this.uniqueName(i.title)),delete i.title,this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,r=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,i,r){r=r||0,i=i||e;var t;for(var o in i)if(i.hasOwnProperty(o)){var s=i[o];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(t in v){l.properties[t]=_.cloneDeep(v[t]);var c=v[t]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=p),l.properties[t]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(a[h]),u=0;u<d.length;++u)for(var m=u+1;m<d.length;++m)d[u]===d[m]&&d.splice(m--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(t in l[h])l[h][t]["x-resolved-from"]=p}i[o]=l}}}};


},{"./http":5,"lodash-compat/lang/cloneDeep":147,"lodash-compat/lang/isArray":149,"lodash-compat/lang/isObject":153,"lodash-compat/lang/isString":155}],7:[function(require,module,exports){
...
},{"../helpers":4,"../schema-markup.js":7,"js-yaml":21,"lodash-compat/lang/isPlainObject":154,"lodash-compat/lang/isString":155}],10:[function(require,module,exports){
"use strict";function maybeTransformValue(e,t){if(Array.isArray(e)&&!_.isUndefined(t)){if("pipes"===t.collectionFormat)return e.join("|");if("tsv"===t.collectionFormat)return e.join("\\t");if("csv"===t.collectionFormat)return e.join(",");if("ssv"===t.collectionFormat)return e.join(" ")}return e}function findParamByName(e,t){return _.find(t,function(t){return t&&e===t.name})}function itemByPriority(e,t){if(_.isEmpty(t))return e[0];for(var r=0,n=t.length;n>r;r++)if(e.indexOf(t[r])>-1)return t[r];return e[0]}var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined"),isEmpty:require("lodash-compat/lang/isEmpty"),isObject:require("lodash-compat/lang/isObject"),filter:require("lodash-compat/collection/filter"),find:require("lodash-compat/collection/find"),each:require("lodash-compat/collection/each"),map:require("lodash-compat/collection/map"),keys:require("lodash-compat/object/keys"),any:require("lodash-compat/collection/any")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Q=require("q"),UriTemplate=require("uritemplate"),Operation=module.exports=function(e,t,r,n,i,o,s,a,p){var l=[];if(e=e||{},o=o||{},e&&e.options&&(this.client=e.options.client||null,this.requestInterceptor=e.options.requestInterceptor||null,this.responseInterceptor=e.options.responseInterceptor||null),this.authorizations=o.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=o.consumes||e.consumes||["application/json"],this.produces=o.produces||e.produces||["application/json"],this.deprecated=o.deprecated,this.description=o.description,this.host=e.host||"localhost",this.method=n||l.push("Operation "+r+" is missing method."),this.models=a||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=o,this.operations={},this.parameters=null!==o?o.parameters||[]:{},this.parent=e,this.path=i||l.push("Operation "+this.nickname+" is missing path."),this.responses=o.responses||{},this.scheme=t||e.scheme||"http",this.schemes=o.schemes||e.schemes,this.security=o.security||e.security,this.summary=o.summary||"",this.type=null,this.useJQuery=e.useJQuery,this.jqueryAjaxCache=e.jqueryAjaxCache,this.enableCookies=e.enableCookies,this.parameterMacro=e.parameterMacro||function(e,t){return t["default"]},this.inlineModels=[],"/"!==this.basePath&&"/"===this.basePath.slice(-1)&&(this.basePath=this.basePath.slice(0,-1)),"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,c;if(s){var h;for(h in s)c=new Model(h,s[h],this.models,e.modelPropertyMacro),c&&(this.models[h]=c)}else s={};for(u=0;u<this.parameters.length;u++){var d=this.parameters[u];d["default"]=this.parameterMacro(this,d),"array"===d.type&&(d.isList=!0,d.allowMultiple=!0);var f=this.getType(d);if(f&&"boolean"===f.toString().toLowerCase()&&(d.allowableValues={},d.isList=!0,d["enum"]=[!0,!1]),"undefined"!=typeof d["x-example"]){var m=d["x-example"];d["default"]=m}if(d["x-examples"]){var m=d["x-examples"]["default"];"undefined"!=typeof m&&(d["default"]=m)}var y=d["enum"]||d.items&&d.items["enum"];if("undefined"!=typeof y){var g;for(d.allowableValues={},d.allowableValues.values=[],d.allowableValues.descriptiveValues=[],g=0;g<y.length;g++){var v=y[g],b=v===d["default"]||v+""===d["default"];d.allowableValues.values.push(v),d.allowableValues.descriptiveValues.push({value:v+"",isDefault:b})}}"array"===d.type&&(f=[f],"undefined"==typeof d.allowableValues&&(delete d.isList,delete d.allowMultiple)),d.modelSignature={type:f,definitions:this.models},d.signature=this.getModelSignature(f,this.models).toString(),d.sampleJSON=this.getModelSampleJSON(f,this.models),d.responseClassSignature=d.signature}var O,C,x=this.responses;if(x[200]?(C=x[200],O="200"):x[201]?(C=x[201],O="201"):x[202]?(C=x[202],O="202"):x[203]?(C=x[203],O="203"):x[204]?(C=x[204],O="204"):x[205]?(C=x[205],O="205"):x[206]?(C=x[206],O="206"):x["default"]&&(C=x["default"],O="default"),C&&C.schema){var w,M=this.resolveModel(C.schema,s);delete x[O],M?(this.successResponse={},w=this.successResponse[O]=M):C.schema.type&&"object"!==C.schema.type&&"array"!==C.schema.type?(this.successResponse={},w=this.successResponse[O]=C.schema):(this.successResponse={},w=this.successResponse[O]=new Model(void 0,C.schema||{},this.models,e.modelPropertyMacro)),w&&(C.description&&(w.description=C.description),C.examples&&(w.examples=C.examples),C.headers&&(w.headers=C.headers)),this.type=C}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t["default"]&&Array.isArray(t["default"])?-1!==t["default"].indexOf(e):e===t["default"]},Operation.prototype.getType=function(e){var t,r=e.type,n=e.format,i=!1;"integer"===r&&"int32"===n?t="integer":"integer"===r&&"int64"===n?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===n?"date-time":"date"===n?"date":"string":"number"===r&&"float"===n?t="float":"number"===r&&"double"===n?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r?(i=!0,e.items&&(t=this.getType(e.items))):"file"===r&&(t="file"),e.$ref&&(t=helpers.simpleRef(e.$ref));var o=e.schema;if(o){var s=o.$ref;return s?(s=helpers.simpleRef(s),i?[s]:s):"object"===o.type?this.addInlineModel(o):this.getType(o)}return i?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10),r=this.inlineModels[t];return r}return null},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var n=this.parameters[r],i=n.signature;t+="\n  * "+n.name+" ("+i+"): "+n.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,n;return e instanceof Array&&(n=!0,e=e[0]),"undefined"==typeof e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?n?"Array["+e+"]":e.toString():n?"Array["+e.getMockSignature()+"]":e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var n=this.parameters[r];if("undefined"!=typeof e[n.name]&&"header"===n["in"]){var i=e[n.name];Array.isArray(i)&&(i=i.toString()),t[n.name]=i}}return t},Operation.prototype.rfc6570CompliantUrl=function(e){var t="",r=this.stripQueryStringVariables(this.stripAnchors(e)),n=_.filter(this.parameters,function(e){return"query"===e["in"]});n.length>0&&(t=r.indexOf("?")>=0?"{&":"{?");for(var i=0,o=0;o<n.length;o++){var s=n[o];i>0&&(t+=",");var a="";"multi"===s.collectionFormat&&(a="*"),t+=this.encodeQueryParam(s.name)+a,i++}return n.length>0&&(t+="}"),r+t},Operation.prototype.stripAnchors=function(e){var t=e.split("#");return t.length>0?t[0]:e},Operation.prototype.stripQueryStringVariables=function(e){var t=/{(\w*)([\?\&]\w+(,\w+)*)}/g;return e.replace(t,"{$1}").replace("{}","").replace("}{","")},Operation.prototype.transformArgs=function(e,t){var r={};return _.each(_.keys(e),function(n){var i=findParamByName(n,t);i&&(r[encodeURIComponent(n)]=maybeTransformValue(e[n],i))}),r},Operation.prototype.urlify=function(e){var t=this.rfc6570CompliantUrl(this.path),r=UriTemplate.parse(t),n=this.scheme+"://"+this.host;return"/"!==this.basePath&&(n+=this.basePath),n+this.unTransformKeys(r.expand(this.transformArgs(e,this.parameters))).replace(new RegExp("%2C","g"),",").replace(new RegExp("%7C","g"),"|").replace(new RegExp("%5Ct","g"),"%09").replace(new RegExp("%7B","g"),"{").replace(new RegExp("%7D","g"),"}")},Operation.prototype.unTransformKeys=function(e){var t,r=e;for(t=0;t<this.parameters.length;t++){var n=encodeURIComponent(this.parameters[t].name).concat("="),i=this.parameters[t].name.concat("=");r=r.replace(n,i)}return r},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var n=this.parameters[t];n.required===!0&&"undefined"==typeof e[n.name]&&(r=n.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var n,i,o,s,a={},p=!1,l=0;l<this.parameters.length;l++){var u=this.parameters[l];"undefined"!=typeof t[u.name]?"body"===u["in"]?i=t[u.name]:"formData"===u["in"]&&(a[u.name]={param:u,value:t[u.name]},n=!0):"body"===u["in"]&&(p=!0)}if(p&&"undefined"==typeof i){var c=e["Content-Type"];c&&0===c.indexOf("application/json")&&(i="{}")}var h=!1;if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&(h=!0),n&&!h){var d="";for(o in a){var u=a[o].param;s=a[o].value,"undefined"!=typeof s&&(Array.isArray(s)?(""!==d&&(d+="&"),d+=this.encodeQueryCollection(u.collectionFormat,o,s)):(""!==d&&(d+="&"),d+=encodeURIComponent(o)+"="+encodeURIComponent(s)))}i=d}else if(h){if("function"==typeof FormData){var f=new FormData;f.type="formData";for(o in a)s=t[o],"undefined"!=typeof s&&("[object File]"==={}.toString.apply(s)?f.append(o,s):"file"===s.type&&s.value?f.append(o,s.value):Array.isArray(s)?f.append(o,this.encodeQueryCollection(u.collectionFormat,o,s)):f.append(o,s));i=f}else{f={};for(o in a)if(s=t[o],Array.isArray(s)){var m,y=u.collectionFormat||"multi";m="ssv"===y?" ":"pipes"===y?"|":"tsv"===y?"	":",";var g;s.forEach(function(e){g?g+=m:g="",g+=e}),f[o]=g}else f[o]=s;i=f}e["Content-Type"]="multipart/form-data"}return i},Operation.prototype.getModelSampleJSON=function(e,t){var r,n,i;if(t=t||{},r=e instanceof Array,i=r?e[0]:e,t[i]?n=t[i].createJSONSample():this.getInlineModel(i)&&(n=this.getInlineModel(i).createJSONSample()),n){if(n=r?[n]:n,"string"==typeof n)return n;if(_.isObject(n)){var o=n;if(n instanceof Array&&n.length>0&&(o=n[0]),o.nodeName&&"Node"==typeof o){var s=(new XMLSerializer).serializeToString(o);return this.formatXml(s)}return JSON.stringify(n,null,2)}return n}},Operation.prototype["do"]=function(e,t,r,n,i){return this.execute(e,t,r,n,i)},Operation.prototype.execute=function(e,t,r,n,i){var o,s,a,p=e||{},l={};_.isObject(t)&&(l=t,o=r,s=n),this.client&&(l.client=this.client),!l.requestInterceptor&&this.requestInterceptor&&(l.requestInterceptor=this.requestInterceptor),!l.responseInterceptor&&this.responseInterceptor&&(l.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(o=t,s=r),this.parent.usePromise?a=Q.defer():(o=o||this.parent.defaultSuccessCallback||helpers.log,s=s||this.parent.defaultErrorCallback||helpers.log),"undefined"==typeof l.useJQuery&&(l.useJQuery=this.useJQuery),"undefined"==typeof l.jqueryAjaxCache&&(l.jqueryAjaxCache=this.jqueryAjaxCache),"undefined"==typeof l.enableCookies&&(l.enableCookies=this.enableCookies);var u=this.getMissingParams(p);if(u.length>0){var c="missing required params: "+u;return helpers.fail(c),this.parent.usePromise?(a.reject(c),a.promise):(s(c,i),{})}var h,d=this.getHeaderParams(p),f=this.setContentTypes(p,l),m={};for(h in d)m[h]=d[h];for(h in f)m[h]=f[h];var y=this.getBody(f,p,l),g=this.urlify(p);if(g.indexOf(".{format}")>0&&m){var v=m.Accept||m.accept;v&&v.indexOf("json")>0?g=g.replace(".{format}",".json"):v&&v.indexOf("xml")>0&&(g=g.replace(".{format}",".xml"))}var b={url:g,method:this.method.toUpperCase(),body:y,enableCookies:l.enableCookies,useJQuery:l.useJQuery,jqueryAjaxCache:l.jqueryAjaxCache,deferred:a,headers:m,clientAuthorizations:l.clientAuthorizations,on:{response:function(e){return a?(a.resolve(e),a.promise):o(e,i)},error:function(e){return a?(a.reject(e),a.promise):s(e,i)}}};return this.clientAuthorizations.apply(b,this.operation.security),l.mock===!0?b:(new SwaggerHttp).execute(b,l)},Operation.prototype.setContentTypes=function(e,t){var r,n,i=this.parameters,o=e.parameterContentType||itemByPriority(this.consumes,["application/json","application/yaml"]),s=t.responseContentType||itemByPriority(this.produces,["application/json","application/yaml"]),a=[],p=[],l={};for(n=0;n<i.length;n++){var u=i[n];if("formData"===u["in"])"file"===u.type?a.push(u):p.push(u);else if("header"===u["in"]&&t){var c=u.name,h=t[u.name];"undefined"!=typeof t[u.name]&&(l[c]=h)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}var d=r||a.length||p.length;if("post"===this.method||"put"===this.method||"patch"===this.method||("delete"===this.method||"get"===this.method)&&d){if(t.requestContentType&&(o=t.requestContentType),p.length>0){if(o=void 0,t.requestContentType)o=t.requestContentType;else if(a.length>0)o="multipart/form-data";else if(this.consumes&&this.consumes.length>0)for(var f in this.consumes){var m=this.consumes[f];(0===m.indexOf("application/x-www-form-urlencoded")||0===m.indexOf("multipart/form-data"))&&(o=m)}"undefined"==typeof o&&(o="application/x-www-form-urlencoded")}}else o=null;return o&&this.consumes&&-1===this.consumes.indexOf(o)&&helpers.log("server doesn't consume "+o+", try "+JSON.stringify(this.consumes)),this.matchesAccept(s)||helpers.log("server can't produce "+s),o&&""!==r||"application/x-www-form-urlencoded"===o?l["Content-Type"]=o:this.consumes&&this.consumes.length>0&&"application/x-www-form-urlencoded"===this.consumes[0]&&(l["Content-Type"]=this.consumes[0]),s&&(l.Accept=s),l},Operation.prototype.matchesAccept=function(e){return e&&this.produces?-1!==this.produces.indexOf(e)||-1!==this.produces.indexOf("*/*"):!0},Operation.prototype.asCurl=function(e,t){var r={mock:!0};if("object"==typeof t)for(var n in t)r[n]=t[n];var i=this.execute(e,r);this.clientAuthorizations.apply(i,this.operation.security);var o=[];if(o.push("-X "+this.method.toUpperCase()),"undefined"!=typeof i.headers){var s;for(s in i.headers){var a=i.headers[s];"string"==typeof a&&(a=a.replace(/\'/g,"\\u0027")),o.push("--header '"+s+": "+a+"'")}}var p=!1,l=!1,u=i.headers["Content-Type"];if(u&&0===u.indexOf("application/x-www-form-urlencoded")?p=!0:u&&0===u.indexOf("multipart/form-data")&&(p=!0,l=!0),i.body){var c;if(_.isObject(i.body)){if(l){l=!0;for(var h=0;h<this.parameters.length;h++){var d=this.parameters[h];if("formData"===d["in"]){c||(c="");var f;f="function"==typeof FormData&&i.body instanceof FormData?i.body.get(d.name):i.body[d.name],f&&("file"===d.type?f.name&&(c+="-F "+d.name+'=@"'+f.name+'" '):(c+="-F ",c+=Array.isArray(f)?this.encodeQueryCollection(d.collectionFormat,d.name,f):this.encodeQueryKey(d.name)+"="+f,c+=" "))}}}c||(c=JSON.stringify(i.body))}else c=i.body;c=c.replace(/\'/g,"%27").replace(/\n/g," \\ \n "),p||(c=c.replace(/&/g,"%26")),l?o.push(c):o.push("-d '"+c.replace(/@/g,"%40")+"'")}return"curl "+o.join(" ")+" '"+i.url+"'"},Operation.prototype.encodePathCollection=function(e,t,r){var n,i="",o="";for(o="ssv"===e?"%20":"tsv"===e?"%09":"pipes"===e?"|":",",n=0;n<r.length;n++)0===n?i=this.encodeQueryParam(r[n]):i+=o+this.encodeQueryParam(r[n]);return i},Operation.prototype.encodeQueryCollection=function(e,t,r){var n,i="";if(e=e||"default","default"===e||"multi"===e)for(n=0;n<r.length;n++)n>0&&(i+="&"),i+=this.encodeQueryKey(t)+"="+this.encodeQueryParam(r[n]);else{var o="";if("csv"===e)o=",";else if("ssv"===e)o="%20";else if("tsv"===e)o="%09";else if("pipes"===e)o="|";else if("brackets"===e)for(n=0;n<r.length;n++)0!==n&&(i+="&"),i+=this.encodeQueryKey(t)+"[]="+this.encodeQueryParam(r[n]);if(""!==o)for(n=0;n<r.length;n++)0===n?i=this.encodeQueryKey(t)+"="+this.encodeQueryParam(r[n]):i+=o+this.encodeQueryParam(r[n])}return i},Operation.prototype.encodeQueryKey=function(e){return encodeURIComponent(e).replace("%5B","[").replace("%5D","]").replace("%24","$")},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)};


},{"../helpers":4,"../http":5,"./model":9,"lodash-compat/collection/any":55,"lodash-compat/collection/each":56,"lodash-compat/collection/filter":57,"lodash-compat/collection/find":58,"lodash-compat/collection/map":61,"lodash-compat/lang/cloneDeep":147,"lodash-compat/lang/isEmpty":150,"lodash-compat/lang/isObject":153,"lodash-compat/lang/isUndefined":157,"lodash-compat/object/keys":158,"q":166,"uritemplate":171}],11:[function(require,module,exports){
...
},{"base64-js":12,"ieee754":19,"is-array":20}],17:[function(require,module,exports){
...
},{"../type":34,"buffer":13}],36:[function(require,module,exports){
...
},{"../internal/baseIndexOf":86,"../internal/binaryIndex":101}],53:[function(require,module,exports){
...
},{"../internal/LazyWrapper":66,"../internal/LodashWrapper":67,"../internal/baseLodash":90,"../internal/isObjectLike":135,"../internal/wrapperClone":146,"../lang/isArray":149}],55:[function(require,module,exports){
module.exports=require("./some");


},{"./some":62}],56:[function(require,module,exports){
module.exports=require("./forEach");


},{"./forEach":59}],57:[function(require,module,exports){
...
},{"../internal/arrayFilter":70,"../internal/baseCallback":74,"../internal/baseFilter":79,"../lang/isArray":149}],58:[function(require,module,exports){
...
},{"../internal/baseEach":78,"../internal/createFind":111}],59:[function(require,module,exports){
...
},{"../internal/arrayEach":69,"../internal/baseEach":78,"../internal/createForEach":112}],60:[function(require,module,exports){
...
},{"../internal/baseIndexOf":86,"../internal/getLength":121,"../internal/isIterateeCall":131,"../internal/isLength":134,"../lang/isArray":149,"../lang/isString":155,"../object/values":161}],61:[function(require,module,exports){
...
},{"../internal/arrayMap":71,"../internal/baseCallback":74,"../internal/baseMap":91,"../lang/isArray":149}],62:[function(require,module,exports){
function some(e,a,r){var i=isArray(e)?arraySome:baseSome;return r&&isIterateeCall(e,a,r)&&(a=void 0),("function"!=typeof a||void 0!==r)&&(a=baseCallback(a,r,3)),i(e,a)}var arraySome=require("../internal/arraySome"),baseCallback=require("../internal/baseCallback"),baseSome=require("../internal/baseSome"),isArray=require("../lang/isArray"),isIterateeCall=require("../internal/isIterateeCall");module.exports=some;


},{"../internal/arraySome":72,"../internal/baseCallback":74,"../internal/baseSome":98,"../internal/isIterateeCall":131,"../lang/isArray":149}],63:[function(require,module,exports){
...
},{"../internal/getNative":123}],64:[function(require,module,exports){
...
},{"../internal/createWrapper":115,"../internal/replaceHolders":141,"./restParam":65}],65:[function(require,module,exports){
...
},{"./baseCreate":77,"./baseLodash":90}],67:[function(require,module,exports){
...
},{"./baseCreate":77,"./baseLodash":90}],68:[function(require,module,exports){
...
},{"../object/keys":158,"./baseCopy":76}],74:[function(require,module,exports){
...
},{"../utility/identity":163,"../utility/property":165,"./baseMatches":92,"./baseMatchesProperty":93,"./bindCallback":103}],75:[function(require,module,exports){
...
},{"../lang/isArray":149,"../lang/isObject":153,"./arrayCopy":68,"./arrayEach":69,"./baseAssign":73,"./baseForOwn":84,"./initCloneArray":125,"./initCloneByTag":126,"./initCloneObject":127,"./isHostObject":129}],76:[function(require,module,exports){
...
},{"../lang/isObject":153}],78:[function(require,module,exports){
...
},{"./baseForOwn":84,"./createBaseEach":107}],79:[function(require,module,exports){
...
},{"./createBaseFor":108}],83:[function(require,module,exports){
...
},{"../object/keysIn":159,"./baseFor":82}],84:[function(require,module,exports){
...
},{"../object/keys":158,"./baseFor":82}],85:[function(require,module,exports){
...
},{"./toObject":144}],86:[function(require,module,exports){
...
},{"./indexOfNaN":124}],87:[function(require,module,exports){
...
},{"../lang/isObject":153,"./baseIsEqualDeep":88,"./isObjectLike":135}],88:[function(require,module,exports){
...
},{"../lang/isArray":149,"../lang/isTypedArray":156,"./equalArrays":116,"./equalByTag":117,"./equalObjects":118,"./isHostObject":129}],89:[function(require,module,exports){
...
},{"./baseIsEqual":87,"./toObject":144}],90:[function(require,module,exports){
...
},{"./baseEach":78,"./isArrayLike":128}],92:[function(require,module,exports){
...
},{"./baseIsMatch":89,"./getMatchData":122,"./toObject":144}],93:[function(require,module,exports){
...
},{"../array/last":53,"../lang/isArray":149,"./baseGet":85,"./baseIsEqual":87,"./baseSlice":97,"./isKey":132,"./isStrictComparable":136,"./toObject":144,"./toPath":145}],94:[function(require,module,exports){
...
},{"./toObject":144}],95:[function(require,module,exports){
...
},{"./baseGet":85,"./toPath":145}],96:[function(require,module,exports){
...
},{"../utility/identity":163,"./metaMap":138}],97:[function(require,module,exports){
...
},{"./baseEach":78}],99:[function(require,module,exports){
...
},{"../utility/identity":163,"./binaryIndexBy":102}],102:[function(require,module,exports){
...
},{"../utility/identity":163}],104:[function(require,module,exports){
(function (global){
...
},{"./getLength":121,"./isLength":134,"./toObject":144}],108:[function(require,module,exports){
...
},{"./toObject":144}],109:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":110}],110:[function(require,module,exports){
...
},{"../lang/isObject":153,"./baseCreate":77}],111:[function(require,module,exports){
...
},{"../lang/isArray":149,"./baseCallback":74,"./baseFind":80,"./baseFindIndex":81}],112:[function(require,module,exports){
...
},{"../lang/isArray":149,"./bindCallback":103}],113:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":68,"./composeArgs":105,"./composeArgsRight":106,"./createCtorWrapper":110,"./isLaziable":133,"./reorder":140,"./replaceHolders":141,"./setData":142}],114:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":110}],115:[function(require,module,exports){
...
},{"./baseSetData":96,"./createBindWrapper":109,"./createHybridWrapper":113,"./createPartialWrapper":114,"./getData":119,"./mergeData":137,"./setData":142}],116:[function(require,module,exports){
...
},{"./arraySome":72}],117:[function(require,module,exports){
...
},{"../object/keys":158}],119:[function(require,module,exports){
...
},{"../utility/noop":164,"./metaMap":138}],120:[function(require,module,exports){
...
},{"./realNames":139}],121:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":94}],122:[function(require,module,exports){
...
},{"../object/pairs":160,"./isStrictComparable":136}],123:[function(require,module,exports){
...
},{"../lang/isNative":152}],124:[function(require,module,exports){
...
},{"./bufferClone":104}],127:[function(require,module,exports){
...
},{"./getLength":121,"./isLength":134}],129:[function(require,module,exports){
...
},{"../lang/isObject":153,"./isArrayLike":128,"./isIndex":130}],132:[function(require,module,exports){
...
},{"../lang/isArray":149,"./toObject":144}],133:[function(require,module,exports){
...
},{"../chain/lodash":54,"./LazyWrapper":66,"./getData":119,"./getFuncName":120}],134:[function(require,module,exports){
...
},{"../lang/isObject":153}],137:[function(require,module,exports){
...
},{"./arrayCopy":68,"./composeArgs":105,"./composeArgsRight":106,"./replaceHolders":141}],138:[function(require,module,exports){
(function (global){
var getNative=require("./getNative"),WeakMap=getNative(global,"WeakMap"),metaMap=WeakMap&&new WeakMap;module.exports=metaMap;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./getNative":123}],139:[function(require,module,exports){
...
},{"./arrayCopy":68,"./isIndex":130}],141:[function(require,module,exports){
...
},{"../date/now":63,"./baseSetData":96}],143:[function(require,module,exports){
...
},{"../lang/isArguments":148,"../lang/isArray":149,"../lang/isString":155,"../object/keysIn":159,"./isIndex":130,"./isLength":134}],144:[function(require,module,exports){
...
},{"../lang/isObject":153,"../lang/isString":155,"../support":162}],145:[function(require,module,exports){
...
},{"../lang/isArray":149,"./baseToString":99}],146:[function(require,module,exports){
...
},{"./LazyWrapper":66,"./LodashWrapper":67,"./arrayCopy":68}],147:[function(require,module,exports){
...
},{"../internal/baseClone":75,"../internal/bindCallback":103}],148:[function(require,module,exports){
...
},{"../internal/isArrayLike":128,"../internal/isObjectLike":135}],149:[function(require,module,exports){
...
},{"../internal/getNative":123,"../internal/isLength":134,"../internal/isObjectLike":135}],150:[function(require,module,exports){
...
},{"../internal/isArrayLike":128,"../internal/isObjectLike":135,"../object/keys":158,"./isArguments":148,"./isArray":149,"./isFunction":151,"./isString":155}],151:[function(require,module,exports){
...
},{"../internal/isHostObject":129,"../internal/isObjectLike":135,"./isFunction":151}],153:[function(require,module,exports){
...
},{"../internal/baseForIn":83,"../internal/isHostObject":129,"../internal/isObjectLike":135,"../support":162,"./isArguments":148}],155:[function(require,module,exports){
...
},{"../internal/isObjectLike":135}],156:[function(require,module,exports){
...
},{"../internal/isLength":134,"../internal/isObjectLike":135}],157:[function(require,module,exports){
...
},{"../internal/getNative":123,"../internal/isArrayLike":128,"../internal/shimKeys":143,"../lang/isObject":153,"../support":162}],159:[function(require,module,exports){
...
},{"../internal/arrayEach":69,"../internal/isIndex":130,"../internal/isLength":134,"../lang/isArguments":148,"../lang/isArray":149,"../lang/isFunction":151,"../lang/isObject":153,"../lang/isString":155,"../support":162}],160:[function(require,module,exports){
...
},{"../internal/toObject":144,"./keys":158}],161:[function(require,module,exports){
...
},{"../internal/baseValues":100,"./keys":158}],162:[function(require,module,exports){
...
},{"../internal/baseProperty":94,"../internal/basePropertyDeep":95,"../internal/isKey":132}],166:[function(require,module,exports){
(function (process){
...
},{"_process":14}],167:[function(require,module,exports){
...
},{"./is-object":168,"./request":170,"./request-base":169,"emitter":17}],168:[function(require,module,exports){
