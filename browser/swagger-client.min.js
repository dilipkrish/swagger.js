...
},{"./helpers":4,"buffer":16,"js-yaml":21,"lodash-compat/lang/isObject":153,"lodash-compat/object/keys":158,"superagent":167}],6:[function(require,module,exports){
...
"use strict";var Helpers=require("./helpers"),_={isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined"),isArray:require("lodash-compat/lang/isArray"),isObject:require("lodash-compat/lang/isObject"),isEmpty:require("lodash-compat/lang/isEmpty"),map:require("lodash-compat/collection/map"),indexOf:require("lodash-compat/array/indexOf"),cloneDeep:require("lodash-compat/lang/cloneDeep"),keys:require("lodash-compat/object/keys"),forEach:require("lodash-compat/collection/forEach")},optionHtml=module.exports.optionHtml=function(e,t){return'<tr><td class="optionName">'+e+":</td><td>"+t+"</td></tr>"};module.exports.typeFromJsonSchema=function(e,t){var i;return"integer"===e&&"int32"===t?i="integer":"integer"===e&&"int64"===t?i="long":"integer"===e&&"undefined"==typeof t?i="long":"string"===e&&"date-time"===t?i="date-time":"string"===e&&"date"===t?i="date":"number"===e&&"float"===t?i="float":"number"===e&&"double"===t?i="double":"number"===e&&"undefined"==typeof t?i="double":"boolean"===e?i="boolean":"string"===e&&(i="string"),i};var getStringSignature=module.exports.getStringSignature=function(e,t){var i="";return"undefined"!=typeof e.$ref?i+=Helpers.simpleRef(e.$ref):"undefined"==typeof e.type?i+="object":"array"===e.type?t?i+=getStringSignature(e.items||e.$ref||{}):(i+="Array[",i+=getStringSignature(e.items||e.$ref||{}),i+="]"):i+="integer"===e.type&&"int32"===e.format?"integer":"integer"===e.type&&"int64"===e.format?"long":"integer"===e.type&&"undefined"==typeof e.format?"long":"string"===e.type&&"date-time"===e.format?"date-time":"string"===e.type&&"date"===e.format?"date":"string"===e.type&&"undefined"==typeof e.format?"string":"number"===e.type&&"float"===e.format?"float":"number"===e.type&&"double"===e.format?"double":"number"===e.type&&"undefined"==typeof e.format?"double":"boolean"===e.type?"boolean":e.$ref?Helpers.simpleRef(e.$ref):e.type,i},schemaToJSON=module.exports.schemaToJSON=function(e,t,i,n){e=Helpers.resolveSchema(e),"function"!=typeof n&&(n=function(e){return(e||{})["default"]}),i=i||{};var r,s,o=e.type||"object",a=e.format;return _.isUndefined(e.example)?_.isUndefined(e.items)&&_.isArray(e["enum"])&&(s=e["enum"][0]):s=e.example,_.isUndefined(s)&&(e.$ref?(r=t[Helpers.simpleRef(e.$ref)],_.isUndefined(r)||(_.isUndefined(i[r.name])?(i[r.name]=r,s=schemaToJSON(r.definition,t,i,n),delete i[r.name]):s="array"===r.type?[]:{})):_.isUndefined(e["default"])?"string"===o?s="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===o?s=0:"number"===o?s=0:"boolean"===o?s=!0:"object"===o?(s={},_.forEach(e.properties,function(e,r){var o=_.cloneDeep(e);o["default"]=n(e),s[r]=schemaToJSON(o,t,i,n)})):"array"===o&&(s=[],_.isArray(e.items)?_.forEach(e.items,function(e){s.push(schemaToJSON(e,t,i,n))}):_.isPlainObject(e.items)?s.push(schemaToJSON(e.items,t,i,n)):_.isUndefined(e.items)?s.push({}):Helpers.log("Array type's 'items' property is not an array or an object, cannot process")):s=e["default"]),s};module.exports.schemaToHTML=function(e,t,i,n){function r(e,t,n){var r,s=t;return e.$ref?(s=e.title||Helpers.simpleRef(e.$ref),r=i[s]):_.isUndefined(t)&&(s=e.title||"Inline Model "+ ++f,r={definition:e}),n!==!0&&(l[s]=_.isUndefined(r)?{}:r.definition),s}function s(e){var t='<span class="propType">',i=e.type||"object";return e.$ref?t+=r(e,Helpers.simpleRef(e.$ref)):"object"===i?t+=_.isUndefined(e.properties)?"object":r(e):"array"===i?(t+="Array[",_.isArray(e.items)?t+=_.map(e.items,r).join(","):_.isPlainObject(e.items)?t+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?r(e.items):e.items.type:r(e.items,Helpers.simpleRef(e.items.$ref)):(Helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),t+="object"),t+="]"):t+=e.type,t+="</span>"}function o(e,t){var i="",n=e.type||"object",r="array"===n;switch(r&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(i+=optionHtml("Default",e["default"])),n){case"string":e.minLength&&(i+=optionHtml("Min. Length",e.minLength)),e.maxLength&&(i+=optionHtml("Max. Length",e.maxLength)),e.pattern&&(i+=optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(i+=optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(i+=optionHtml("Exclusive Min.","true")),e.maximum&&(i+=optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(i+=optionHtml("Exclusive Max.","true")),e.multipleOf&&(i+=optionHtml("Multiple Of",e.multipleOf))}if(r&&(e.minItems&&(i+=optionHtml("Min. Items",e.minItems)),e.maxItems&&(i+=optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(i+=optionHtml("Unique Items","true")),e.collectionFormat&&(i+=optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var s;s="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',i+=optionHtml("Enum",s)}return i.length>0&&(t='<span class="propWrap">'+t+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+i+"</table></span>"),t}function a(e,t){var a=e.type||"object",l="array"===e.type,f=p+t+" "+(l?"[":"{")+m;if(t&&d.push(t),l)_.isArray(e.items)?f+="<div>"+_.map(e.items,function(e){var t=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],t)>-1?"object"===t&&_.isUndefined(e.properties)?"object":r(e):o(e,t):r(e,Helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?f+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"<div>object</div>":"<div>"+r(e.items)+"</div>":"<div>"+o(e.items,e.items.type)+"</div>":"<div>"+r(e.items,Helpers.simpleRef(e.items.$ref))+"</div>":(Helpers.log("Array type's 'items' property is not an array or an object, cannot process"),f+="<div>object</div>");else if(e.$ref)f+="<div>"+r(e,t)+"</div>";else if("object"===a){if(_.isPlainObject(e.properties)){var u=_.map(e.properties,function(t,r){var a,p,m=_.indexOf(e.required,r)>=0,l=_.cloneDeep(t),d=m?"required":"",f='<span class="propName '+d+'">'+r+"</span> (";return l["default"]=n(l),l=Helpers.resolveSchema(l),p=t.description||l.description,_.isUndefined(l.$ref)||(a=i[Helpers.simpleRef(l.$ref)],_.isUndefined(a)||-1!==_.indexOf([void 0,"array","object"],a.definition.type)||(l=Helpers.resolveSchema(a.definition))),f+=s(l),m||(f+=', <span class="propOptKey">optional</span>'),t.readOnly&&(f+=', <span class="propReadOnly">read only</span>'),f+=")",_.isUndefined(p)||(f+=': <span class="propDesc">'+p+"</span>"),l["enum"]&&(f+=' = <span class="propVals">[\''+l["enum"].join("', '")+"']</span>"),"<div"+(t.readOnly?' class="readOnly"':"")+">"+o(l,f)}).join(",</div>");u&&(f+=u+"</div>")}}else f+="<div>"+o(e,a)+"</div>";return f+p+(l?"]":"}")+m}var p='<span class="strong">',m="</span>";if(_.isObject(arguments[0])&&(e=void 0,t=arguments[0],i=arguments[1],n=arguments[2]),i=i||{},t=Helpers.resolveSchema(t),_.isEmpty(t))return p+"Empty"+m;if("string"==typeof t.$ref&&(e=Helpers.simpleRef(t.$ref),t=i[e],"undefined"==typeof t))return p+e+" is not defined!"+m;"string"!=typeof e&&(e=t.title||"Inline Model"),t.definition&&(t=t.definition),"function"!=typeof n&&(n=function(e){return(e||{})["default"]});for(var l={},d=[],f=0,u=a(t,e);_.keys(l).length>0;)_.forEach(l,function(e,t){var i=_.indexOf(d,t)>-1;delete l[t],i||(d.push(t),u+="<br />"+a(e,t))});return u};
...
"use strict";function maybeTransformValue(e,t){if(Array.isArray(e)&&!_.isUndefined(t)){if("pipes"===t.collectionFormat)return e.join("|");if("tsv"===t.collectionFormat)return e.join("\\t");if("csv"===t.collectionFormat)return e.join(",");if("ssv"===t.collectionFormat)return e.join(" ")}return e}function findParamByName(e,t){return _.find(t,function(t){return t&&e===t.name})}function itemByPriority(e,t){if(_.isEmpty(t))return e[0];for(var r=0,i=t.length;i>r;r++)if(e.indexOf(t[r])>-1)return t[r];return e[0]}var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined"),isEmpty:require("lodash-compat/lang/isEmpty"),isObject:require("lodash-compat/lang/isObject"),filter:require("lodash-compat/collection/filter"),find:require("lodash-compat/collection/find"),each:require("lodash-compat/collection/each"),map:require("lodash-compat/collection/map"),keys:require("lodash-compat/object/keys"),any:require("lodash-compat/collection/any")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Q=require("q"),UriTemplate=require("uritemplate"),Operation=module.exports=function(e,t,r,i,n,o,s,a,p){var l=[];e=e||{},o=o||{},e&&e.options&&(this.client=e.options.client||null,this.requestInterceptor=e.options.requestInterceptor||null,this.responseInterceptor=e.options.responseInterceptor||null),this.authorizations=o.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=o.consumes||e.consumes||["application/json"],this.produces=o.produces||e.produces||["application/json"],this.deprecated=o.deprecated,this.description=o.description,this.host=e.host,this.method=i||l.push("Operation "+r+" is missing method."),this.models=a||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=o,this.operations={},this.parameters=null!==o?o.parameters||[]:{},this.parent=e,this.path=n||l.push("Operation "+this.nickname+" is missing path."),this.responses=o.responses||{},this.scheme=t||e.scheme||"http",this.schemes=o.schemes||e.schemes,this.security=o.security||e.security,this.summary=o.summary||"",this.timeout=e.timeout,this.type=null,this.useJQuery=e.useJQuery,this.jqueryAjaxCache=e.jqueryAjaxCache,this.enableCookies=e.enableCookies;var u;if(this.host||("undefined"!=typeof window?this.host=window.location.host:this.host="localhost"),this.parameterMacro=e.parameterMacro||function(e,t){return t["default"]},this.inlineModels=[],"/"!==this.basePath&&"/"===this.basePath.slice(-1)&&(this.basePath=this.basePath.slice(0,-1)),"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var c,h;if(s)for(u in s)h=new Model(u,s[u],this.models,e.modelPropertyMacro),h&&(this.models[u]=h);else s={};for(c=0;c<this.parameters.length;c++){var f,d=this.parameters[c];d["default"]=this.parameterMacro(this,d),"array"===d.type&&(d.isList=!0,d.allowMultiple=!0);var m=this.getType(d);m&&"boolean"===m.toString().toLowerCase()&&(d.allowableValues={},d.isList=!0,d["enum"]=[!0,!1]);for(u in d)helpers.extractExtensions(u,d);"undefined"!=typeof d["x-example"]&&(f=d["x-example"],d["default"]=f),d["x-examples"]&&(f=d["x-examples"]["default"],"undefined"!=typeof f&&(d["default"]=f));var y=d["enum"]||d.items&&d.items["enum"];if("undefined"!=typeof y){var g;for(d.allowableValues={},d.allowableValues.values=[],d.allowableValues.descriptiveValues=[],g=0;g<y.length;g++){var v=y[g],b=v===d["default"]||v+""===d["default"];d.allowableValues.values.push(v),d.allowableValues.descriptiveValues.push({value:v+"",isDefault:b})}}"array"===d.type&&(m=[m],"undefined"==typeof d.allowableValues&&(delete d.isList,delete d.allowMultiple)),d.modelSignature={type:m,definitions:this.models},d.signature=this.getModelSignature(m,this.models).toString(),d.sampleJSON=this.getModelSampleJSON(m,this.models),d.responseClassSignature=d.signature}var x,O,C,w=this.responses;w[200]?(C=w[200],O="200"):w[201]?(C=w[201],O="201"):w[202]?(C=w[202],O="202"):w[203]?(C=w[203],O="203"):w[204]?(C=w[204],O="204"):w[205]?(C=w[205],O="205"):w[206]?(C=w[206],O="206"):w["default"]&&(C=w["default"],O="default");for(x in w)if(helpers.extractExtensions(x,w),"string"==typeof x&&-1===x.indexOf("x-")){var j=w[x];if("object"==typeof j&&"object"==typeof j.headers){var M=j.headers;for(var A in M){var q=M[A];if("object"==typeof q)for(var P in q)helpers.extractExtensions(P,q)}}}if(C)for(x in C)helpers.extractExtensions(x,C);if(C&&C.schema){var S,I=this.resolveModel(C.schema,s);delete w[O],I?(this.successResponse={},S=this.successResponse[O]=I):C.schema.type&&"object"!==C.schema.type&&"array"!==C.schema.type?(this.successResponse={},S=this.successResponse[O]=C.schema):(this.successResponse={},S=this.successResponse[O]=new Model(void 0,C.schema||{},this.models,e.modelPropertyMacro)),S&&(S.vendorExtensions=C.vendorExtensions,C.description&&(S.description=C.description),C.examples&&(S.examples=C.examples),C.headers&&(S.headers=C.headers)),this.type=C}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t["default"]&&Array.isArray(t["default"])?-1!==t["default"].indexOf(e):e===t["default"]},Operation.prototype.getType=function(e){var t,r=e.type,i=e.format,n=!1;"integer"===r&&"int32"===i?t="integer":"integer"===r&&"int64"===i?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===i?"date-time":"date"===i?"date":"string":"number"===r&&"float"===i?t="float":"number"===r&&"double"===i?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r?(n=!0,e.items&&(t=this.getType(e.items))):"file"===r&&(t="file"),e.$ref&&(t=helpers.simpleRef(e.$ref));var o=e.schema;if(o){var s=o.$ref;return s?(s=helpers.simpleRef(s),n?[s]:s):"object"===o.type?this.addInlineModel(o):this.getType(o)}return n?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10),r=this.inlineModels[t];return r}return null},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var i=this.parameters[r],n=i.signature;t+="\n  * "+i.name+" ("+n+"): "+i.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,i;return e instanceof Array&&(i=!0,e=e[0]),"undefined"==typeof e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?i?"Array["+e+"]":e.toString():i?"Array["+e.getMockSignature()+"]":e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r={},i=0;i<this.parameters.length;i++){var n=this.parameters[i];"header"===n["in"]&&(r[n.name.toLowerCase()]=n)}for(var o in e){var s=r[o.toLowerCase()];if("undefined"!=typeof s){var a=e[o];Array.isArray(a)&&(a=a.toString()),t[s.name]=a}}return t},Operation.prototype.rfc6570CompliantUrl=function(e){var t="",r=this.stripQueryStringVariables(this.stripAnchors(e)),i=_.filter(this.parameters,function(e){return"query"===e["in"]});i.length>0&&(t=r.indexOf("?")>=0?"{&":"{?");for(var n=0,o=0;o<i.length;o++){var s=i[o];n>0&&(t+=",");var a="";"multi"===s.collectionFormat&&(a="*"),t+=this.encodeQueryParam(s.name)+a,n++}return i.length>0&&(t+="}"),r+t},Operation.prototype.stripAnchors=function(e){var t=e.split("#");return t.length>0?t[0]:e},Operation.prototype.stripQueryStringVariables=function(e){var t=/{(\w*)([\?\&]\w+(,\w+)*)}/g;return e.replace(t,"{$1}").replace("{}","").replace("}{","")},Operation.prototype.transformArgs=function(e,t){var r={};return _.each(_.keys(e),function(i){var n=findParamByName(i,t);n&&(r[encodeURIComponent(i)]=maybeTransformValue(e[i],n))}),r},Operation.prototype.urlify=function(e){var t=this.rfc6570CompliantUrl(this.path),r=UriTemplate.parse(t),i=this.scheme+"://"+this.host;return"/"!==this.basePath&&(i+=this.basePath),i+this.unTransformKeys(r.expand(this.transformArgs(e,this.parameters))).replace(new RegExp("%2C","g"),",").replace(new RegExp("%7C","g"),"|").replace(new RegExp("%5Ct","g"),"%09").replace(new RegExp("%7B","g"),"{").replace(new RegExp("%7D","g"),"}")},Operation.prototype.unTransformKeys=function(e){var t,r=e;for(t=0;t<this.parameters.length;t++){var i=encodeURIComponent(this.parameters[t].name).concat("="),n=this.parameters[t].name.concat("=");r=r.replace(i,n)}return r},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var i=this.parameters[t];i.required===!0&&"undefined"==typeof e[i.name]&&(r=i.name)}return r},Operation.prototype.getBody=function(e,t){for(var r,i,n,o,s,a={},p=!1,l=0;l<this.parameters.length;l++)i=this.parameters[l],"undefined"!=typeof t[i.name]?"body"===i["in"]?n=t[i.name]:"formData"===i["in"]&&(a[i.name]={param:i,value:t[i.name]},r=!0):"body"===i["in"]&&(p=!0);if(p&&"undefined"==typeof n){var u=e["Content-Type"];u&&0===u.indexOf("application/json")&&(n="{}")}var c=!1;if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&(c=!0),r&&!c){var h="";for(o in a)i=a[o].param,s=a[o].value,"undefined"!=typeof s&&(Array.isArray(s)?(""!==h&&(h+="&"),h+=this.encodeQueryCollection(i.collectionFormat,o,s)):(""!==h&&(h+="&"),h+=encodeURIComponent(o)+"="+encodeURIComponent(s)));n=h}else if(c){var f;if("function"==typeof FormData){f=new FormData,f.type="formData";for(o in a)if(i=a[o].param,s=t[o],"undefined"!=typeof s)if("[object File]"==={}.toString.apply(s))f.append(o,s);else if("file"===s.type&&s.value)f.append(o,s.value);else if(Array.isArray(s))if("multi"===i.collectionFormat){f["delete"](o);for(var d in s)f.append(o,s[d])}else f.append(o,this.encodeQueryCollection(i.collectionFormat,o,s).split("=").slice(1).join("="));else f.append(o,s);n=f}else{f={};for(o in a)if(s=t[o],Array.isArray(s)){var m,y=i.collectionFormat||"multi";if("ssv"===y)m=" ";else if("pipes"===y)m="|";else if("tsv"===y)m="	";else{if("multi"===y){f[o]=s;break}m=","}var g;s.forEach(function(e){g?g+=m:g="",g+=e}),f[o]=g}else f[o]=s;n=f}e["Content-Type"]="multipart/form-data"}return n},Operation.prototype.getModelSampleJSON=function(e,t){var r,i,n;if(t=t||{},r=e instanceof Array,n=r?e[0]:e,t[n]?i=t[n].createJSONSample():this.getInlineModel(n)&&(i=this.getInlineModel(n).createJSONSample()),i){if(i=r?[i]:i,"string"==typeof i)return i;if(_.isObject(i)){var o=i;if(i instanceof Array&&i.length>0&&(o=i[0]),o.nodeName&&"Node"==typeof o){var s=(new XMLSerializer).serializeToString(o);return this.formatXml(s)}return JSON.stringify(i,null,2)}return i}},Operation.prototype["do"]=function(e,t,r,i,n){return this.execute(e,t,r,i,n)},Operation.prototype.execute=function(e,t,r,i,n){var o,s,a,p,l=e||{},u={};_.isObject(t)&&(u=t,o=r,s=i),p="undefined"!=typeof u.timeout?u.timeout:this.timeout,this.client&&(u.client=this.client),!u.requestInterceptor&&this.requestInterceptor&&(u.requestInterceptor=this.requestInterceptor),!u.responseInterceptor&&this.responseInterceptor&&(u.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(o=t,s=r),this.parent.usePromise?a=Q.defer():(o=o||this.parent.defaultSuccessCallback||helpers.log,s=s||this.parent.defaultErrorCallback||helpers.log),"undefined"==typeof u.useJQuery&&(u.useJQuery=this.useJQuery),"undefined"==typeof u.jqueryAjaxCache&&(u.jqueryAjaxCache=this.jqueryAjaxCache),"undefined"==typeof u.enableCookies&&(u.enableCookies=this.enableCookies);var c=this.getMissingParams(l);if(c.length>0){var h="missing required params: "+c;return helpers.fail(h),this.parent.usePromise?(a.reject(h),a.promise):(s(h,n),{})}var f,d=this.getHeaderParams(l),m=this.setContentTypes(l,u),y={};for(f in d)y[f]=d[f];for(f in m)y[f]=m[f];var g=this.getBody(m,l,u),v=this.urlify(l);if(v.indexOf(".{format}")>0&&y){var b=y.Accept||y.accept;b&&b.indexOf("json")>0?v=v.replace(".{format}",".json"):b&&b.indexOf("xml")>0&&(v=v.replace(".{format}",".xml"))}var x={url:v,method:this.method.toUpperCase(),body:g,enableCookies:u.enableCookies,useJQuery:u.useJQuery,jqueryAjaxCache:u.jqueryAjaxCache,deferred:a,headers:y,clientAuthorizations:u.clientAuthorizations,on:{response:function(e){return a?(a.resolve(e),a.promise):o(e,n)},error:function(e){return a?(a.reject(e),a.promise):s(e,n)}}};return p&&(x.timeout=p),this.clientAuthorizations.apply(x,this.operation.security),u.mock===!0?x:(new SwaggerHttp).execute(x,u)},Operation.prototype.setContentTypes=function(e,t){var r,i,n=this.parameters,o=e.parameterContentType||itemByPriority(this.consumes,["application/json","application/yaml"]),s=t.responseContentType||itemByPriority(this.produces,["application/json","application/yaml"]),a=[],p=[],l={};for(i=0;i<n.length;i++){var u=n[i];if("formData"===u["in"])"file"===u.type?a.push(u):p.push(u);else if("header"===u["in"]&&t){var c=u.name,h=t[u.name];"undefined"!=typeof t[u.name]&&(l[c]=h)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}var f=r||a.length||p.length;if("post"===this.method||"put"===this.method||"patch"===this.method||("delete"===this.method||"get"===this.method)&&f){if(t.requestContentType&&(o=t.requestContentType),p.length>0){if(o=void 0,t.requestContentType)o=t.requestContentType;else if(a.length>0)o="multipart/form-data";else if(this.consumes&&this.consumes.length>0)for(var d in this.consumes){var m=this.consumes[d];(0===m.indexOf("application/x-www-form-urlencoded")||0===m.indexOf("multipart/form-data"))&&(o=m)}"undefined"==typeof o&&(o="application/x-www-form-urlencoded")}}else o=null;return o&&this.consumes&&-1===this.consumes.indexOf(o)&&helpers.log("server doesn't consume "+o+", try "+JSON.stringify(this.consumes)),this.matchesAccept(s)||helpers.log("server can't produce "+s),o&&""!==r||"application/x-www-form-urlencoded"===o?l["Content-Type"]=o:this.consumes&&this.consumes.length>0&&"application/x-www-form-urlencoded"===this.consumes[0]&&(l["Content-Type"]=this.consumes[0]),s&&(l.Accept=s),l},Operation.prototype.matchesAccept=function(e){return e&&this.produces?-1!==this.produces.indexOf(e)||-1!==this.produces.indexOf("*/*"):!0},Operation.prototype.asCurl=function(e,t){var r={mock:!0};if("object"==typeof t)for(var i in t)r[i]=t[i];var n=this.execute(e,r);this.clientAuthorizations.apply(n,this.operation.security);var o=[];if(o.push("-X "+this.method.toUpperCase()),"undefined"!=typeof n.headers){var s;for(s in n.headers){var a=n.headers[s];"string"==typeof a&&(a=a.replace(/\'/g,"\\u0027")),o.push("--header '"+s+": "+a+"'")}}var p=!1,l=!1,u=n.headers["Content-Type"];if(u&&0===u.indexOf("application/x-www-form-urlencoded")?p=!0:u&&0===u.indexOf("multipart/form-data")&&(p=!0,l=!0),n.body){var c;if(_.isObject(n.body)){if(l){l=!0;for(var h=0;h<this.parameters.length;h++){var f=this.parameters[h];if("formData"===f["in"]){c||(c="");var d;if(d="function"==typeof FormData&&n.body instanceof FormData?n.body.getAll(f.name):n.body[f.name])if("file"===f.type)d.name&&(c+="-F "+f.name+'=@"'+d.name+'" ');else if(Array.isArray(d))if("multi"===f.collectionFormat)for(var m in d)c+="-F "+this.encodeQueryKey(f.name)+"="+d[m]+" ";else c+="-F "+this.encodeQueryCollection(f.collectionFormat,f.name,d)+" ";else c+="-F "+this.encodeQueryKey(f.name)+"="+d+" "}}}c||(c=JSON.stringify(n.body))}else c=n.body;c=c.replace(/\'/g,"%27").replace(/\n/g," \\ \n "),p||(c=c.replace(/&/g,"%26")),l?o.push(c):o.push("-d '"+c.replace(/@/g,"%40")+"'")}return"curl "+o.join(" ")+" '"+n.url+"'"},Operation.prototype.encodePathCollection=function(e,t,r){var i,n="",o="";for(o="ssv"===e?"%20":"tsv"===e?"%09":"pipes"===e?"|":",",i=0;i<r.length;i++)0===i?n=this.encodeQueryParam(r[i]):n+=o+this.encodeQueryParam(r[i]);return n},Operation.prototype.encodeQueryCollection=function(e,t,r){var i,n="";if(e=e||"default","default"===e||"multi"===e)for(i=0;i<r.length;i++)i>0&&(n+="&"),n+=this.encodeQueryKey(t)+"="+this.encodeQueryParam(r[i]);else{var o="";if("csv"===e)o=",";else if("ssv"===e)o="%20";else if("tsv"===e)o="%09";else if("pipes"===e)o="|";else if("brackets"===e)for(i=0;i<r.length;i++)0!==i&&(n+="&"),n+=this.encodeQueryKey(t)+"[]="+this.encodeQueryParam(r[i]);if(""!==o)for(i=0;i<r.length;i++)0===i?n=this.encodeQueryKey(t)+"="+this.encodeQueryParam(r[i]):n+=o+this.encodeQueryParam(r[i])}return n},Operation.prototype.encodeQueryKey=function(e){return encodeURIComponent(e).replace("%5B","[").replace("%5D","]").replace("%24","$")},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)};
