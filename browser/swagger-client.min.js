...
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var s=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(s=!0),"OPTIONS"===e.method.toLowerCase()&&"SuperagentHttpClient"==typeof r&&(log("forcing jQuery as OPTIONS are not supported by SuperAgent"),e.useJQuery=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!s))throw new Error("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&s)&&(r=new JQueryHttpClient(t));var n=e.on.response,o=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},a=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),n(e)};return e.on.response=function(e){a(e)},_.isObject(e)&&_.isObject(e.body)&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(o(e)),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=this.jQuery||window.jQuery,r=e.on,s=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var t={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var p=a.substring(0,u).trim(),i=a.substring(u+1).trim();t[p]=i}else t[a]=null}}var l={url:s.url,method:s.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var d=e.responseJSON||jsyaml.safeLoad(e.responseText);l.obj="string"==typeof d?{}:d}catch(y){helpers.log("unable to parse JSON/YAML content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)r.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(l);r.error(l)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},n=request[t](e.url);for(r in s)n.set(r,s[r]);e.enableCookies&&n.withCredentials(),e.body&&n.send(e.body),"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(n.errObj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{n.obj=JSON.parse(n.statusText)}catch(o){n.obj=null}s=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&Object.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(o){helpers.log("cannot parse JSON/YAML content")}n.obj="object"==typeof a?a:null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"js-yaml":20,"lodash-compat/lang/isObject":152,"superagent":166}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,i,r,o,t,s){var n,l,f;r["x-resolved-from"]=["#/definitions/"+i];var a=r.allOf;for(a.sort(function(e,i){return e.$ref&&i.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+i+"/allOf",this.resolveInline(e,s,f,o,t,l)},Resolver.prototype.resolve=function(e,i,r,o){this.spec=e;var t,s,n=i,l=r,f=o,a={};"function"==typeof i&&(n=null,l=i,f=r);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,y={},O={},g=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,g,O,e):this.resolveTo(n,c,g,"/definitions");m.allOf&&this.processAllOf(n,h,m,g,O,e)}for(h in e.paths){var x,b,A;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,g,O,t);else{b=v[x];var k=v.parameters||[],j=b.parameters||[];for(s in k){var R=k[s];j.unshift(R)}"parameters"!==x&&_.isObject(b)&&(b.parameters=b.parameters||j);for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var $="inline_model",h=$,w=!1,I=0;!w;){if("undefined"==typeof e.definitions[h]){w=!0;break}h=$+"_"+I,I++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],g,O,e)}else this.resolveTo(n,R.schema,g,t);R.$ref&&this.resolveInline(n,e,R,g,O,R.$ref)}for(A in b.responses){var q=b.responses[A];if(t="/paths"+h+"/"+x+"/responses/"+A,_.isObject(q)&&(q.$ref&&this.resolveInline(n,e,q,g,O,t),q.schema)){var T=q;if(_.isArray(T.schema.allOf)){for(var $="inline_model",h=$,w=!1,I=0;!w;){if("undefined"==typeof e.definitions[h]){w=!0;break}h=$+"_"+I,I++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],g,O,e)}else this.resolveTo(n,q.schema,g,t)}}}v.parameters=[]}var D,S=0,H=[],P=g;for(s=0;s<P.length;s++){var z=P[s];if(n===z.root){if("ref"===z.resolveAs){var N,U=((z.root||"")+"/"+z.key).split("/"),E=[],J="";if(z.key.indexOf("../")>=0){for(var Q=0;Q<U.length;Q++)".."===U[Q]?E=E.slice(0,E.length-1):E.push(U[Q]);for(N=0;N<E.length;N++)N>0&&(J+="/"),J+=E[N];z.root=J,H.push(z)}else if(D=z.key.split("#"),2===D.length){(0===D[0].indexOf("http://")||0===D[0].indexOf("https://"))&&(z.root=D[0]),t=D[1].split("/");var B,C=e;for(N=0;N<t.length;N++){var F=t[N];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&H.push(z)}}else if("inline"===z.resolveAs){if(z.key&&-1===z.key.indexOf("#")&&"/"!==z.key.charAt(0)){for(D=z.root.split("/"),t="",s=0;s<D.length-1;s++)t+=D[s]+"/";t+=z.key,z.root=t,z.location=""}H.push(z)}}else H.push(z)}S=H.length;for(var G=0;G<H.length;G++)!function(e,i,r){if(null===e.root||e.root===n)r.resolveItem(i,p,g,y,O,e),u+=1,u===S&&r.finish(i,n,g,y,O,l,!0);else{var o={useJQuery:!1,url:e.root,method:"get",headers:{accept:r.scope.swaggerRequestHeaders||"application/json"},on:{error:function(o){u+=1,O[e.key]={root:e.root,location:e.location},u===S&&r.finish(i,p,g,y,O,l)},response:function(o){var t=o.obj;r.resolveItem(t,e.root,g,y,O,e),u+=1,u===S&&r.finish(i,p,g,y,O,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(o),(new SwaggerHttp).execute(o,a)}}(H[G],e,this);0===Object.keys(H).length&&this.finish(e,p,g,y,O,l)},Resolver.prototype.resolveItem=function(e,i,r,o,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?o[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,i,r,o,t,s,n){var l;for(l in r){var f=r[l],a=f.key,p=o[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj)var h=this.retainRoot(p.obj[a],f.root);e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(p.obj[a],f.root)),v[a]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,i,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var i,r=this.getRefs(e),o=[],t=[];for(i in r)0===i.indexOf("#")?o.push(i.substring(1)):t.push(i);for(i=0;i<o.length;i++)for(var s=o[i],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,i){i=i||e;var r={};for(var o in i)if(i.hasOwnProperty(o)){var t=i[o];if("$ref"===o&&"string"==typeof t)r[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)r[n]=null}}return r},Resolver.prototype.retainRoot=function(e,i){for(var r in e){var o=e[r];if("$ref"===r&&"string"==typeof o){if(0!==o.indexOf("http://")&&0!==o.indexOf("https://")){var t=!0;if(i){var s=i.slice(-1);if("/"!==s&&0!==o.indexOf("#")&&0!==o.indexOf("http://")&&o.indexOf("https://")){console.log("working with "+o),t=!1;var n=i.split("/");n=n.splice(0,n.length-1),i="";for(var l=0;l<n.length;l++)i+=n[l]+"/"}}0!==o.indexOf("#")&&t&&(o="#"+o),o=(i||"")+o,e[r]=o}}else _.isObject(o)&&this.retainRoot(o,i)}return e},Resolver.prototype.resolveInline=function(e,i,r,o,t,s){var n,l,f,a,p=r.$ref,h=r.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})):o.push({obj:r,resolveAs:"inline",root:e,key:p,location:s})}else"array"===r.type&&this.resolveTo(e,r.items,o,s)},Resolver.prototype.resolveTo=function(e,i,r,o){var t,s,n=i.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}o=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,o="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,o=""}r.push({obj:i,resolveAs:"ref",root:l,key:n,location:o})}else if("array"===i.type){var a=i.items;this.resolveTo(e,a,r,o)}else if(i&&i.properties){var p=this.uniqueName("inline_model");this.spec.definitions[p]=_.cloneDeep(i),i.$ref="#/definitions/"+p,delete i.type,delete i.properties}},Resolver.prototype.uniqueName=function(e){for(var i=e,r=0;;){if(!_.isObject(this.spec.definitions[i]))return i;i=e+"_"+r,r++}},Resolver.prototype.resolveAllOf=function(e,i,r){r=r||0,i=i||e;var o;for(var t in i)if(i.hasOwnProperty(t)){var s=i[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+i+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,r+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(o in v){l.properties[o]=_.cloneDeep(v[o]);var c=v[o]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=p),l.properties[o]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(a[h]),u=0;u<d.length;++u)for(var y=u+1;y<d.length;++y)d[u]===d[y]&&d.splice(y--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(o in l[h])l[h][o]["x-resolved-from"]=p}i[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,r+1)}};
